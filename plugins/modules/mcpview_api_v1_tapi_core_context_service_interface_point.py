...
DOCUMENTATION = """
module: mcpview_api_v1_tapi_core_context_service_interface_point
short_description: Handle resource of type mcpview_api_v1_tapi_core_context_service_interface_point
description: Handle resource of type mcpview_api_v1_tapi_core_context_service_interface_point
options:
  page[number]:
    description:
