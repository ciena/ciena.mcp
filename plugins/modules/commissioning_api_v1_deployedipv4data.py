...
DOCUMENTATION = """
module: commissioning_api_v1_deployedipv4data
short_description: Handle resource of type commissioning_api_v1_deployedipv4data
description: Handle resource of type commissioning_api_v1_deployedipv4data
options:
  shelfNumber:
    description:
    - Shelf Number
...
def prepare_argument_spec():
    ...
    argument_spec["tid"] = {"type": "str", "operationIds": ["delete", "get"]}
    argument_spec["state"] = {"type": "str", "choices": ["delete", "get", "post"]}
    argument_spec["shelfNumber"] = {"type": "str", "operationIds": ["delete"]}
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/deployedIPv4Data/".format(
        **params
    )
...
async def _delete(params, session):
    accepted_fields = ["shelfNumber", "tid"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/commissioning/api/v1/deployedIPv4Data/".format(
        **params
