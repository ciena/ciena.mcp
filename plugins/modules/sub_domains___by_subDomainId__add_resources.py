...
DOCUMENTATION = """
module: sub_domains___by_subDomainId__add_resources
short_description: Handle resource of type sub_domains___by_subDomainId__add_resources
description: Handle resource of type sub_domains___by_subDomainId__add_resources
options:
  resources:
    description: []
    type: list
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/add-resources".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/add-resources".format(
        **params
    )
