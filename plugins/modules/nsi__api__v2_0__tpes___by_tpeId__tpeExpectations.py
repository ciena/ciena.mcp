...
DOCUMENTATION = """
module: nsi__api__v2_0__tpes___by_tpeId__tpeExpectations
short_description: Handle resource of type nsi__api__v2_0__tpes___by_tpeId__tpeExpectations
description: Handle resource of type nsi__api__v2_0__tpes___by_tpeId__tpeExpectations
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2_0/tpes/{tpeId}/tpeExpectations".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v2_0/tpes/{tpeId}/tpeExpectations".format(
        **params
