...
DOCUMENTATION = """
module: configmgmt_api_v1_upgrade_rtrvupgradestatus
short_description: Handle resource of type configmgmt_api_v1_upgrade_rtrvupgradestatus
description: Handle resource of type configmgmt_api_v1_upgrade_rtrvupgradestatus
options:
  networkConstructName:
    description:
    - Networkconstruct Name for which details need to be retrieved.
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["networkConstructName"]
...
def prepare_argument_spec():
    ...
    argument_spec["networkConstructName"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/upgrade/rtrvUpgradeStatus".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/upgrade/rtrvUpgradeStatus".format(
        **params
