...
DOCUMENTATION = """
module: ifd_api_serviceintents_by_id_route
short_description: Handle resource of type ifd_api_serviceintents_by_id_route
description: Handle resource of type ifd_api_serviceintents_by_id_route
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/serviceIntents/{id}/route".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/ifd/api/serviceIntents/{id}/route".format(
        **params
