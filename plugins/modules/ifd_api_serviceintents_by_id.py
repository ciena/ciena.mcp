...
DOCUMENTATION = """
module: ifd_api_serviceintents_by_id
short_description: Handle resource of type ifd_api_serviceintents_by_id
description: Handle resource of type ifd_api_serviceintents_by_id
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/serviceIntents/{id}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/ifd/api/serviceIntents/{id}".format(
        **params
