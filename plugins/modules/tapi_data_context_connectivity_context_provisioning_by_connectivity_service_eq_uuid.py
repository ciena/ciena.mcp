...
DOCUMENTATION = """
module: tapi_data_context_connectivity_context_provisioning_by_connectivity_service_eq_uuid
short_description: Handle resource of type tapi_data_context_connectivity_context_provisioning_by_connectivity_service_eq_uuid
description: Handle resource of type tapi_data_context_connectivity_context_provisioning_by_connectivity_service_eq_uuid
options:
  state:
    choices:
    - delete
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/connectivity-context/provisioning/connectivity-service={uuid}".format(
        **params
    )
