...
DOCUMENTATION = """
module: nsi_api_physicallocations_by_physicallocationid
short_description: Handle resource of type nsi_api_physicallocations_by_physicallocationid
description: Handle resource of type nsi_api_physicallocations_by_physicallocationid
options:
  physicalLocationId:
    description:
...
def url(params):
    return (
        "https://{mcp_hostname}/nsi/api/physicalLocations/{physicalLocationId}".format(
            **params
        )
    )
