...
DOCUMENTATION = """
module: nsi_api_v3_tpes_by_tpeid_expectations_by_expectationid_realize
short_description: Handle resource of type nsi_api_v3_tpes_by_tpeid_expectations_by_expectationid_realize
description: Handle resource of type nsi_api_v3_tpes_by_tpeid_expectations_by_expectationid_realize
options:
  expectationId:
    description:
...
async def _post(params, session):
    accepted_fields = ["expectationId", "tpeId"]
    spec = {}
