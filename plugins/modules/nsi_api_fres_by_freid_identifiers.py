...
DOCUMENTATION = """
module: nsi_api_fres_by_freid_identifiers
short_description: Handle resource of type nsi_api_fres_by_freid_identifiers
description: Handle resource of type nsi_api_fres_by_freid_identifiers
options:
  freId:
    description:
    - The FRE id
