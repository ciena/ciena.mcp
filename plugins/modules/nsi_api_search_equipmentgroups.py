...
DOCUMENTATION = """
module: nsi_api_search_equipmentgroups
short_description: Handle resource of type nsi_api_search_equipmentgroups
description: Handle resource of type nsi_api_search_equipmentgroups
options:
  endDateMax:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/search/equipmentGroups".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/search/equipmentGroups".format(
        **params
