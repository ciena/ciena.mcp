...
DOCUMENTATION = """
module: resources___by_resourceId__history
short_description: Handle resource of type resources___by_resourceId__history
description: Handle resource of type resources___by_resourceId__history
options:
  after:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/history".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/history".format(
        **params
    ) + gen_args(
