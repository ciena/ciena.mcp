...
DOCUMENTATION = """
module: tapi_data_context_connectivity_context_provisioning_connectivity_service
short_description: Handle resource of type tapi_data_context_connectivity_context_provisioning_connectivity_service
description: Handle resource of type tapi_data_context_connectivity_context_provisioning_connectivity_service
options:
  state:
    choices:
    - post
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/connectivity-context/provisioning/connectivity-service/".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/connectivity-context/provisioning/connectivity-service/".format(
        **params
    ) + gen_args(
