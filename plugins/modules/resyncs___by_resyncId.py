...
DOCUMENTATION = """
module: resyncs___by_resyncId
short_description: Handle resource of type resyncs___by_resyncId
description: Handle resource of type resyncs___by_resyncId
options:
  resyncId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resyncs/{resyncId}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resyncs/{resyncId}".format(
        **params
