...
DOCUMENTATION = """
module: mcpview_api_v1_tapi_core_context_physical_context_equipment
short_description: Handle resource of type mcpview_api_v1_tapi_core_context_physical_context_equipment
description: Handle resource of type mcpview_api_v1_tapi_core_context_physical_context_equipment
options:
  page[number]:
    description:
