...
DOCUMENTATION = """
module: nsi_api_v2_0_equipment_by_equipmentid_equipmentexpectations_by_equipmentexpectationid
short_description: Handle resource of type nsi_api_v2_0_equipment_by_equipmentid_equipmentexpectations_by_equipmentexpectationid
description: Handle resource of type nsi_api_v2_0_equipment_by_equipmentid_equipmentexpectations_by_equipmentexpectationid
options:
...
def prepare_argument_spec():
    ...
    argument_spec["equipmentExpectationId"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2_0/equipment/{equipmentId}/equipmentExpectations/{equipmentExpectationId}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v2_0/equipment/{equipmentId}/equipmentExpectations/{equipmentExpectationId}".format(
        **params
    ) + gen_args(
