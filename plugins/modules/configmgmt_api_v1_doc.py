...
DOCUMENTATION = """
module: configmgmt_api_v1_doc
short_description: Handle resource of type configmgmt_api_v1_doc
description: Handle resource of type configmgmt_api_v1_doc
options:
  docDetails:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["networkConstructNames"]
...
def prepare_argument_spec():
    ...
    argument_spec["operationType"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["networkConstructNames"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["docDetails"] = {"type": "list", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/doc".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/doc".format(**params) + gen_args(
...
async def _post(params, session):
    accepted_fields = ["docDetails", "operationType"]
    spec = {}
