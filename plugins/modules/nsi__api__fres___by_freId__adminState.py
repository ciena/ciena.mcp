...
DOCUMENTATION = """
module: nsi__api__fres___by_freId__adminState
short_description: Handle resource of type nsi__api__fres___by_freId__adminState
description: Handle resource of type nsi__api__fres___by_freId__adminState
options:
  adminStateValue:
    description:
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/fres/{freId}/adminState".format(**params)
