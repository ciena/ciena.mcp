...
DOCUMENTATION = """
module: nsi__api__v2_0__fres
short_description: Handle resource of type nsi__api__v2_0__fres
description: Handle resource of type nsi__api__v2_0__fres
options:
  childFreId:
    description:
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v2_0/fres".format(**params)
