...
DOCUMENTATION = """
module: configmgmt_api_v1_batches
short_description: Handle resource of type configmgmt_api_v1_batches
description: Handle resource of type configmgmt_api_v1_batches
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/batches".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/batches".format(
        **params
