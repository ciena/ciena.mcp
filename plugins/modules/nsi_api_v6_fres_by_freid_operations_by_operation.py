...
DOCUMENTATION = """
module: nsi_api_v6_fres_by_freid_operations_by_operation
short_description: Handle resource of type nsi_api_v6_fres_by_freid_operations_by_operation
description: Handle resource of type nsi_api_v6_fres_by_freid_operations_by_operation
options:
  freId:
    description:
    - FRE identifier
