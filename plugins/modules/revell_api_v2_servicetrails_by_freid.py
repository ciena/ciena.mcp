...
DOCUMENTATION = """
module: revell_api_v2_servicetrails_by_freid
short_description: Handle resource of type revell_api_v2_servicetrails_by_freid
description: Handle resource of type revell_api_v2_servicetrails_by_freid
options:
  endTpeId:
    description:
  ...
  include:
    ...
    - 'List of comma separated resources to be side-loaded. The allowed values are:
      fres, tpes, networkConstructs, equipment, expectations, frePlanned, freDiscovered,
      abstracts'
    - Used by I(state=['get'])
    type: str
  startTpeId:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["endTpeId", "include", "startTpeId", "traversalScope"]
...
def prepare_argument_spec():
    ...
    argument_spec["traversalScope"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["state"] = {"type": "str", "choices": ["get"]}
    argument_spec["startTpeId"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["include"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["freId"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["endTpeId"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/revell/api/v2/serviceTrails/{freId}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/revell/api/v2/serviceTrails/{freId}".format(
        **params
