...
DOCUMENTATION = """
module: mcpview_api_v1_tapi_core_context_physical_context_device
short_description: Handle resource of type mcpview_api_v1_tapi_core_context_physical_context_device
description: Handle resource of type mcpview_api_v1_tapi_core_context_physical_context_device
options:
  page[number]:
    description:
