...
DOCUMENTATION = """
module: commissioning_api_v1_deploymentdata
short_description: Handle resource of type commissioning_api_v1_deploymentdata
description: Handle resource of type commissioning_api_v1_deploymentdata
options:
  data:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["projectname"]
...
def prepare_argument_spec():
    ...
    argument_spec["projectname"] = {"type": "str", "operationIds": ["get", "post"]}
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/deploymentData/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/commissioning/api/v1/deploymentData/".format(
        **params
...
async def _post(params, session):
    accepted_fields = ["data", "projectname"]
    spec = {}
