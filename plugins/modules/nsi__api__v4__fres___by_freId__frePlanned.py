...
DOCUMENTATION = """
module: nsi__api__v4__fres___by_freId__frePlanned
short_description: Handle resource of type nsi__api__v4__fres___by_freId__frePlanned
description: Handle resource of type nsi__api__v4__fres___by_freId__frePlanned
options:
  data:
    description:
  ...
  include:
    ...
    - '(Optional) List of comma separated resources to be side-loaded. The allowed
      values are: fres, tpes, equipment'
    type: str
  included:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v4/fres/{freId}/frePlanned".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v4/fres/{freId}/frePlanned".format(
        **params
...
async def _patch(params, session):
    accepted_fields = ["operations"]
    spec = {}
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v4/fres/{freId}/frePlanned".format(**params)
