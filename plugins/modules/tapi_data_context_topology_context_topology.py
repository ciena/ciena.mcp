...
DOCUMENTATION = """
module: tapi_data_context_topology_context_topology
short_description: Handle resource of type tapi_data_context_topology_context_topology
description: Handle resource of type tapi_data_context_topology_context_topology
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/topology-context/topology/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/topology-context/topology/".format(
        **params
