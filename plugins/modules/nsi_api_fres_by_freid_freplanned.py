...
DOCUMENTATION = """
module: nsi_api_fres_by_freid_freplanned
short_description: Handle resource of type nsi_api_fres_by_freid_freplanned
description: Handle resource of type nsi_api_fres_by_freid_freplanned
options:
  data:
    description:
