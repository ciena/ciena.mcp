...
DOCUMENTATION = """
module: nsi_api_v3_networkconstructs_by_id_expectations_by_networkconstructexpectationid_by_attributename
short_description: Handle resource of type nsi_api_v3_networkconstructs_by_id_expectations_by_networkconstructexpectationid_by_attributename
description: Handle resource of type nsi_api_v3_networkconstructs_by_id_expectations_by_networkconstructexpectationid_by_attributename
options:
  attributeName:
    description:
    - 'Name of attribute to update, allowable values: name, ipAddress and shelfType '
...
def prepare_argument_spec():
    ...
    argument_spec["networkConstructExpectationId"] = {
        "type": "str",
        "operationIds": ["put"],
    }
    argument_spec["id"] = {"type": "str", "operationIds": ["put"]}
    argument_spec["body"] = {"type": "str", "operationIds": ["put"]}
    argument_spec["attributeName"] = {"type": "str", "operationIds": ["put"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/networkConstructs/{id}/expectations/{networkConstructExpectationId}/{attributeName}".format(
        **params
    )
...
async def _put(params, session):
    accepted_fields = ["attributeName", "body", "id", "networkConstructExpectationId"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v3/networkConstructs/{id}/expectations/{networkConstructExpectationId}/{attributeName}".format(
        **params
    ) + gen_args(
