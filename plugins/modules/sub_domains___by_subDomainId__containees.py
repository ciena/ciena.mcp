...
DOCUMENTATION = """
module: sub_domains___by_subDomainId__containees
short_description: Handle resource of type sub_domains___by_subDomainId__containees
description: Handle resource of type sub_domains___by_subDomainId__containees
options:
  limit:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/containees".format(
        **params
    )
