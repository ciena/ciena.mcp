...
DOCUMENTATION = """
module: ifd_api_serviceintents_by_id_update
short_description: Handle resource of type ifd_api_serviceintents_by_id_update
description: Handle resource of type ifd_api_serviceintents_by_id_update
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/serviceIntents/{id}/update".format(**params)
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/ifd/api/serviceIntents/{id}/update".format(
        **params
