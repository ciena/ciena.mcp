...
DOCUMENTATION = """
module: nsi_api_v3_networkconstructs_by_id_expectations_by_networkconstructexpectationid
short_description: Handle resource of type nsi_api_v3_networkconstructs_by_id_expectations_by_networkconstructexpectationid
description: Handle resource of type nsi_api_v3_networkconstructs_by_id_expectations_by_networkconstructexpectationid
options:
  id:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["id"] = {"type": "str", "operationIds": ["delete", "get"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/networkConstructs/{id}/expectations/{networkConstructExpectationId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/networkConstructs/{id}/expectations/{networkConstructExpectationId}".format(
        **params
    ) + gen_args(
