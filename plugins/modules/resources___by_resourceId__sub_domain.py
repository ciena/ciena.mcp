...
DOCUMENTATION = """
module: resources___by_resourceId__sub_domain
short_description: Handle resource of type resources___by_resourceId__sub_domain
description: Handle resource of type resources___by_resourceId__sub_domain
options:
  resourceId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/sub-domain".format(
        **params
    )
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/sub-domain".format(
        **params
    )
