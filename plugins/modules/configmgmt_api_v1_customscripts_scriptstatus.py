...
DOCUMENTATION = """
module: configmgmt_api_v1_customscripts_scriptstatus
short_description: Handle resource of type configmgmt_api_v1_customscripts_scriptstatus
description: Handle resource of type configmgmt_api_v1_customscripts_scriptstatus
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/customScripts/scriptStatus".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/customScripts/scriptStatus".format(
        **params
