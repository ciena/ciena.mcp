...
DOCUMENTATION = """
module: tapi_data_context_physical_context_by_device_eq_uuid
short_description: Handle resource of type tapi_data_context_physical_context_by_device_eq_uuid
description: Handle resource of type tapi_data_context_physical_context_by_device_eq_uuid
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/physical-context/device={uuid}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/physical-context/device={uuid}".format(
        **params
    ) + gen_args(
