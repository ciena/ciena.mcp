...
DOCUMENTATION = """
module: configmgmt_api_v1_jobs
short_description: Handle resource of type configmgmt_api_v1_jobs
description: Handle resource of type configmgmt_api_v1_jobs
options:
  data:
    description:
    - 'Validate attributes are:'
    - ' - C(attributes) (dict): '
    - ' - C(batchattributes) (dict): '
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/jobs".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/jobs".format(**params) + gen_args(
