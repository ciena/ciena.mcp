...
DOCUMENTATION = """
module: nsi_api_search_networkconstructs
short_description: Handle resource of type nsi_api_search_networkconstructs
description: Handle resource of type nsi_api_search_networkconstructs
options:
  associationState:
    description:
  ...
  displayResourceState:
    description:
    - '(Optional) List of networkConstruct resourceStates. The allowed values are:
      root, planned, discovered, unknown'
    - Used by I(state=['get'])
    type: str
  displaySyncState:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/search/networkConstructs".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/search/networkConstructs".format(
        **params
