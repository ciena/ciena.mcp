...
DOCUMENTATION = """
module: application_slices___by_applicationSliceId__parents
short_description: Handle resource of type application_slices___by_applicationSliceId__parents
description: Handle resource of type application_slices___by_applicationSliceId__parents
options:
  applicationSliceId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/parents".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/parents".format(
        **params
    ) + gen_args(
