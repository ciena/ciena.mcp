...
DOCUMENTATION = """
module: discovery__api__v3__managementSessions___by_sessionId__ipAddress
short_description: Handle resource of type discovery__api__v3__managementSessions___by_sessionId__ipAddress
description: Handle resource of type discovery__api__v3__managementSessions___by_sessionId__ipAddress
options:
  body:
    description:
    - A string value of the IpAddress
    type: str
  sessionId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/discovery/api/v3/managementSessions/{sessionId}/ipAddress".format(
        **params
    )
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/discovery/api/v3/managementSessions/{sessionId}/ipAddress".format(
        **params
    )
