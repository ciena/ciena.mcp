...
DOCUMENTATION = """
module: nsi_api_v2_0_physicallocations_by_physicallocationid
short_description: Handle resource of type nsi_api_v2_0_physicallocations_by_physicallocationid
description: Handle resource of type nsi_api_v2_0_physicallocations_by_physicallocationid
options:
  physicalLocationId:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["physicalLocationId"] = {"type": "str", "operationIds": ["delete"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2_0/physicalLocations/{physicalLocationId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v2_0/physicalLocations/{physicalLocationId}".format(
        **params
    ) + gen_args(
