...
DOCUMENTATION = """
module: discovery__api__neprofiles
short_description: Handle resource of type discovery__api__neprofiles
description: Handle resource of type discovery__api__neprofiles
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/discovery/api/neprofiles".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/discovery/api/neprofiles".format(
        **params
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/discovery/api/neprofiles".format(**params)
