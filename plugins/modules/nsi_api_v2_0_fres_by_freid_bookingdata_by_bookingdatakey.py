...
DOCUMENTATION = """
module: nsi_api_v2_0_fres_by_freid_bookingdata_by_bookingdatakey
short_description: Handle resource of type nsi_api_v2_0_fres_by_freid_bookingdata_by_bookingdatakey
description: Handle resource of type nsi_api_v2_0_fres_by_freid_bookingdata_by_bookingdatakey
options:
  bookingDataKey:
    description:
...
async def _put(params, session):
    accepted_fields = ["bookingDataKey", "bookingDataValue", "freId"]
    spec = {}
