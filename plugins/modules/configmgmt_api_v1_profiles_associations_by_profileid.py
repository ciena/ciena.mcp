...
DOCUMENTATION = """
module: configmgmt_api_v1_profiles_associations_by_profileid
short_description: Handle resource of type configmgmt_api_v1_profiles_associations_by_profileid
description: Handle resource of type configmgmt_api_v1_profiles_associations_by_profileid
options:
  profileId:
    description:
    - The ftp profile id for which associations to be retrieved.
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/profiles/associations/{profileId}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/profiles/associations/{profileId}".format(
        **params
    ) + gen_args(
