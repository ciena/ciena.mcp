...
DOCUMENTATION = """
module: v1_bpi_credentials
short_description: Handle resource of type v1_bpi_credentials
description: Handle resource of type v1_bpi_credentials
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/dct/api/v1/bpi/credentials/".format(**params)
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/dct/api/v1/bpi/credentials/".format(
        **params
