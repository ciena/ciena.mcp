...
DOCUMENTATION = """
module: discovery__api__v1__neprofiles
short_description: Handle resource of type discovery__api__v1__neprofiles
description: Handle resource of type discovery__api__v1__neprofiles
options:
  data:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["protocol", "typeGroup"]
...
def prepare_argument_spec():
    ...
    argument_spec["protocol"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/discovery/api/v1/neprofiles".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/discovery/api/v1/neprofiles".format(
        **params
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/discovery/api/v1/neprofiles".format(**params)
