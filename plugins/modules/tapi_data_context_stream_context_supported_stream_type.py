...
DOCUMENTATION = """
module: tapi_data_context_stream_context_supported_stream_type
short_description: Handle resource of type tapi_data_context_stream_context_supported_stream_type
description: Handle resource of type tapi_data_context_stream_context_supported_stream_type
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/stream-context/supported-stream-type/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/stream-context/supported-stream-type/".format(
        **params
    ) + gen_args(
