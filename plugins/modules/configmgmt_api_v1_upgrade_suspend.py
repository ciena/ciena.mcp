...
DOCUMENTATION = """
module: configmgmt_api_v1_upgrade_suspend
short_description: Handle resource of type configmgmt_api_v1_upgrade_suspend
description: Handle resource of type configmgmt_api_v1_upgrade_suspend
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/upgrade/suspend".format(**params)
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/configmgmt/api/v1/upgrade/suspend".format(
        **params
