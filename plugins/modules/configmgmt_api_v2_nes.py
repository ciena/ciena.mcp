...
DOCUMENTATION = """
module: configmgmt_api_v2_nes
short_description: Handle resource of type configmgmt_api_v2_nes
description: Handle resource of type configmgmt_api_v2_nes
options:
  batchType:
    choices:
    - BACKUP
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v2/nes".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v2/nes".format(**params) + gen_args(
