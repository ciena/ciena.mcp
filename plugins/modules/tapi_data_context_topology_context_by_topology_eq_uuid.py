...
DOCUMENTATION = """
module: tapi_data_context_topology_context_by_topology_eq_uuid
short_description: Handle resource of type tapi_data_context_topology_context_by_topology_eq_uuid
description: Handle resource of type tapi_data_context_topology_context_by_topology_eq_uuid
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/topology-context/topology={uuid}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/topology-context/topology={uuid}".format(
        **params
    ) + gen_args(
