...
DOCUMENTATION = """
module: configmgmt_api_v1_upgrade_fpgadetails
short_description: Handle resource of type configmgmt_api_v1_upgrade_fpgadetails
description: Handle resource of type configmgmt_api_v1_upgrade_fpgadetails
options:
  AID:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["AID", "networkConstructName"]
...
def prepare_argument_spec():
    ...
    argument_spec["AID"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/upgrade/fpgaDetails".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/upgrade/fpgaDetails".format(
        **params
