...
DOCUMENTATION = """
module: discovery_api_managementsessions
short_description: Handle resource of type discovery_api_managementsessions
description: Handle resource of type discovery_api_managementsessions
options:
  aliasName:
    description:
