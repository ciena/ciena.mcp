...
DOCUMENTATION = """
module: admin_sessions
short_description: Handle resource of type admin_sessions
description: Handle resource of type admin_sessions
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/rbac-e/api/v1/admin/sessions".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/rbac-e/api/v1/admin/sessions".format(
        **params
