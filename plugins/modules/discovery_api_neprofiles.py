...
DOCUMENTATION = """
module: discovery_api_neprofiles
short_description: Handle resource of type discovery_api_neprofiles
description: Handle resource of type discovery_api_neprofiles
options:
  data:
    description:
