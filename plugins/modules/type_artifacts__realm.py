...
DOCUMENTATION = """
module: type_artifacts__realm
short_description: Handle resource of type type_artifacts__realm
description: Handle resource of type type_artifacts__realm
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/type-artifacts/realm".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/type-artifacts/realm".format(
        **params
