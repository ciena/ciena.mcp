...
DOCUMENTATION = """
module: nsi_api_v4_networkconstructs_by_id_physicallocation_by_physicallocationid
short_description: Handle resource of type nsi_api_v4_networkconstructs_by_id_physicallocation_by_physicallocationid
description: Handle resource of type nsi_api_v4_networkconstructs_by_id_physicallocation_by_physicallocationid
options:
  body:
    description:
  ...
  id:
    description:
    - Identifier of Network Construct under which to create or update the physical
      location
...
def prepare_argument_spec():
    ...
    argument_spec["physicalLocationId"] = {
        "type": "str",
        "operationIds": ["delete", "put"],
    }
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v4/networkConstructs/{id}/physicalLocation/{physicalLocationId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v4/networkConstructs/{id}/physicalLocation/{physicalLocationId}".format(
        **params
    ) + gen_args(
...
async def _put(params, session):
    accepted_fields = ["body", "id", "physicalLocationId"]
    spec = {}
