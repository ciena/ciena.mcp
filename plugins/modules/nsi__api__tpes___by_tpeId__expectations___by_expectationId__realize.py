...
DOCUMENTATION = """
module: nsi__api__tpes___by_tpeId__expectations___by_expectationId__realize
short_description: Handle resource of type nsi__api__tpes___by_tpeId__expectations___by_expectationId__realize
description: Handle resource of type nsi__api__tpes___by_tpeId__expectations___by_expectationId__realize
options:
  expectationId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/tpes/{tpeId}/expectations/{expectationId}/realize".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/nsi/api/tpes/{tpeId}/expectations/{expectationId}/realize".format(
        **params
    ) + gen_args(
