...
DOCUMENTATION = """
module: commissioning_api_v2_ipsubnet
short_description: Handle resource of type commissioning_api_v2_ipsubnet
description: Handle resource of type commissioning_api_v2_ipsubnet
options:
  data:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["ospfArea"] = {"type": "str", "operationIds": ["delete"]}
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v2/ipsubnet/".format(**params)
