...
DOCUMENTATION = """
module: tapi_core_context_topology_mcp_base_topology_link
short_description: Handle resource of type tapi_core_context_topology_mcp_base_topology_link
description: Handle resource of type tapi_core_context_topology_mcp_base_topology_link
options:
  limit:
    description:
