...
DOCUMENTATION = """
module: mcpview_api_v1_tapi_core_context_connection
short_description: Handle resource of type mcpview_api_v1_tapi_core_context_connection
description: Handle resource of type mcpview_api_v1_tapi_core_context_connection
options:
  page[number]:
    description:
