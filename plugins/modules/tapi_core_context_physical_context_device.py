...
DOCUMENTATION = """
module: tapi_core_context_physical_context_device
short_description: Handle resource of type tapi_core_context_physical_context_device
description: Handle resource of type tapi_core_context_physical_context_device
options:
  limit:
    description:
