...
DOCUMENTATION = """
module: configmgmt_api_v1_upgrade_manualinvoke
short_description: Handle resource of type configmgmt_api_v1_upgrade_manualinvoke
description: Handle resource of type configmgmt_api_v1_upgrade_manualinvoke
options:
...
def prepare_argument_spec():
    ...
    argument_spec["slotId"] = {"type": "str", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/upgrade/manualInvoke".format(
        **params
    )
