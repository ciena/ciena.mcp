...
DOCUMENTATION = """
module: configmgmt_api_v1_port_provision
short_description: Handle resource of type configmgmt_api_v1_port_provision
description: Handle resource of type configmgmt_api_v1_port_provision
options:
  clientType:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["slot"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["shelf"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["scriptFileProperties"] = {"type": "dict", "operationIds": ["post"]}
    argument_spec["reSyncInventory"] = {"type": "bool", "operationIds": ["post"]}
    argument_spec["rate"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["port"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["otn"] = {"type": "bool", "operationIds": ["post"]}
    argument_spec["name"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["maxFrameSize"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["description"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["customerId"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["clientType"] = {"type": "str", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/port/provision".format(**params)
