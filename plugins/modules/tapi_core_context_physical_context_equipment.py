...
DOCUMENTATION = """
module: tapi_core_context_physical_context_equipment
short_description: Handle resource of type tapi_core_context_physical_context_equipment
description: Handle resource of type tapi_core_context_physical_context_equipment
options:
  limit:
    description:
