...
DOCUMENTATION = """
module: nsi_api_networkconstructs
short_description: Handle resource of type nsi_api_networkconstructs
description: Handle resource of type nsi_api_networkconstructs
options:
  concrete:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs".format(
        **params
