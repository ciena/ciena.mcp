...
DOCUMENTATION = """
module: discovery_api_managementsessions_by_sessionid
short_description: Handle resource of type discovery_api_managementsessions_by_sessionid
description: Handle resource of type discovery_api_managementsessions_by_sessionid
options:
  operations:
    description: []
    type: list
