...
DOCUMENTATION = """
module: nsi_api_fres_by_freid_userdata_by_userdatakey
short_description: Handle resource of type nsi_api_fres_by_freid_userdata_by_userdatakey
description: Handle resource of type nsi_api_fres_by_freid_userdata_by_userdatakey
options:
  freId:
    description:
    - FRE identifier
