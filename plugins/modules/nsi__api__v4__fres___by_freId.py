...
DOCUMENTATION = """
module: nsi__api__v4__fres___by_freId
short_description: Handle resource of type nsi__api__v4__fres___by_freId
description: Handle resource of type nsi__api__v4__fres___by_freId
options:
  data:
    description:
...
async def _patch(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v4/fres/{freId}".format(**params)
