...
DOCUMENTATION = """
module: ifd_api_serviceintents_by_id_resourcetrackers
short_description: Handle resource of type ifd_api_serviceintents_by_id_resourcetrackers
description: Handle resource of type ifd_api_serviceintents_by_id_resourcetrackers
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/serviceIntents/{id}/resourceTrackers".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/ifd/api/serviceIntents/{id}/resourceTrackers".format(
        **params
