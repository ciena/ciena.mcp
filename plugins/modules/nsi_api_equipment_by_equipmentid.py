...
DOCUMENTATION = """
module: nsi_api_equipment_by_equipmentid
short_description: Handle resource of type nsi_api_equipment_by_equipmentid
description: Handle resource of type nsi_api_equipment_by_equipmentid
options:
  data:
    description:
    - The equipment data
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/equipment/{equipmentId}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/equipment/{equipmentId}".format(
        **params
