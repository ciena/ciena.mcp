...
DOCUMENTATION = """
module: nsi_api_equipment_by_eqpid_expectations
short_description: Handle resource of type nsi_api_equipment_by_eqpid_expectations
description: Handle resource of type nsi_api_equipment_by_eqpid_expectations
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/equipment/{eqpId}/expectations".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/equipment/{eqpId}/expectations".format(
        **params
