...
DOCUMENTATION = """
module: discovery__api__v4__managementSessions___by_sessionId
short_description: Handle resource of type discovery__api__v4__managementSessions___by_sessionId
description: Handle resource of type discovery__api__v4__managementSessions___by_sessionId
options:
  operations:
    description: []
    type: list
...
def prepare_argument_spec():
    ...
    argument_spec["sessionId"] = {"type": "str", "operationIds": ["patch"]}
