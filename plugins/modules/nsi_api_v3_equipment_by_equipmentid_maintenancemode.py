...
DOCUMENTATION = """
module: nsi_api_v3_equipment_by_equipmentid_maintenancemode
short_description: Handle resource of type nsi_api_v3_equipment_by_equipmentid_maintenancemode
description: Handle resource of type nsi_api_v3_equipment_by_equipmentid_maintenancemode
options:
  body:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["equipmentId"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["body"] = {"type": "bool", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/equipment/{equipmentId}/maintenanceMode".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v3/equipment/{equipmentId}/maintenanceMode".format(
        **params
    ) + gen_args(
