...
DOCUMENTATION = """
module: tapi_data_context_by_service_interface_point_eq_uuid
short_description: Handle resource of type tapi_data_context_by_service_interface_point_eq_uuid
description: Handle resource of type tapi_data_context_by_service_interface_point_eq_uuid
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/service-interface-point={uuid}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/service-interface-point={uuid}".format(
        **params
    ) + gen_args(
