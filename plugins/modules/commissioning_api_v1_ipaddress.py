...
DOCUMENTATION = """
module: commissioning_api_v1_ipaddress
short_description: Handle resource of type commissioning_api_v1_ipaddress
description: Handle resource of type commissioning_api_v1_ipaddress
options:
  state:
    choices:
    - get
...
def prepare_argument_spec():
    ...
    argument_spec["tid"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["subnet"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/ipaddress/".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/commissioning/api/v1/ipaddress/".format(
        **params
