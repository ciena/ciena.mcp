...
DOCUMENTATION = """
module: products___by_productId
short_description: Handle resource of type products___by_productId
description: Handle resource of type products___by_productId
options:
  active:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/products/{productId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/products/{productId}".format(
        **params
