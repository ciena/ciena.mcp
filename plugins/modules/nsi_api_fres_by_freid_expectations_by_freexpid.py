...
DOCUMENTATION = """
module: nsi_api_fres_by_freid_expectations_by_freexpid
short_description: Handle resource of type nsi_api_fres_by_freid_expectations_by_freexpid
description: Handle resource of type nsi_api_fres_by_freid_expectations_by_freexpid
options:
  freExpId:
    description:
...
async def _patch(params, session):
    accepted_fields = ["freExpId", "freId", "operations"]
    spec = {}
