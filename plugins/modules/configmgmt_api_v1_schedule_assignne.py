...
DOCUMENTATION = """
module: configmgmt_api_v1_schedule_assignne
short_description: Handle resource of type configmgmt_api_v1_schedule_assignne
description: Handle resource of type configmgmt_api_v1_schedule_assignne
options:
...
def prepare_argument_spec():
    ...
    argument_spec["state"] = {"type": "str", "choices": ["delete", "post"]}
    argument_spec["resourcePartitionInfo"] = {
        "type": "list",
        "operationIds": ["delete", "post"],
    }
    argument_spec["ipAddress"] = {"type": "str", "operationIds": ["delete", "post"]}
    argument_spec["backupSchedule"] = {
        "type": "str",
        "operationIds": ["delete", "post"],
    }
    argument_spec["additionalIpAddresses"] = {
        "type": "list",
        "operationIds": ["delete", "post"],
    }
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/schedule/assignNE".format(**params)
