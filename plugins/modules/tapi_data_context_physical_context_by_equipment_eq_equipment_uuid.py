...
DOCUMENTATION = """
module: tapi_data_context_physical_context_by_equipment_eq_equipment_uuid
short_description: Handle resource of type tapi_data_context_physical_context_by_equipment_eq_equipment_uuid
description: Handle resource of type tapi_data_context_physical_context_by_equipment_eq_equipment_uuid
options:
  equipment-uuid:
    description:
    - Id of equipment
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/physical-context/equipment={equipment-uuid}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/physical-context/equipment={equipment-uuid}".format(
        **params
    ) + gen_args(
