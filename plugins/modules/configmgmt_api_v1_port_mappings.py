...
DOCUMENTATION = """
module: configmgmt_api_v1_port_mappings
short_description: Handle resource of type configmgmt_api_v1_port_mappings
description: Handle resource of type configmgmt_api_v1_port_mappings
options:
  file:
    description:
    - The Input stream of the pec code mapping definition to be uploaded.
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/port/mappings".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/port/mappings".format(
        **params
