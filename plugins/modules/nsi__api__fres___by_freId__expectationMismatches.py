...
DOCUMENTATION = """
module: nsi__api__fres___by_freId__expectationMismatches
short_description: Handle resource of type nsi__api__fres___by_freId__expectationMismatches
description: Handle resource of type nsi__api__fres___by_freId__expectationMismatches
options:
  freId:
    description:
    - Identifier of the FRE
    type: str
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/fres/{freId}/expectationMismatches".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/fres/{freId}/expectationMismatches".format(
        **params
