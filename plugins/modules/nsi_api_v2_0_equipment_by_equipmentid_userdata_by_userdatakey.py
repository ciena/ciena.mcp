...
DOCUMENTATION = """
module: nsi_api_v2_0_equipment_by_equipmentid_userdata_by_userdatakey
short_description: Handle resource of type nsi_api_v2_0_equipment_by_equipmentid_userdata_by_userdatakey
description: Handle resource of type nsi_api_v2_0_equipment_by_equipmentid_userdata_by_userdatakey
options:
  equipmentId:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["equipmentId"] = {"type": "str", "operationIds": ["delete", "put"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2_0/equipment/{equipmentId}/userData/{userDataKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v2_0/equipment/{equipmentId}/userData/{userDataKey}".format(
        **params
    ) + gen_args(
...
async def _put(params, session):
    accepted_fields = ["equipmentId", "userDataKey", "userDataValue"]
    spec = {}
