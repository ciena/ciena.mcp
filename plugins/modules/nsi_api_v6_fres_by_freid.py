...
DOCUMENTATION = """
module: nsi_api_v6_fres_by_freid
short_description: Handle resource of type nsi_api_v6_fres_by_freid
description: Handle resource of type nsi_api_v6_fres_by_freid
options:
  fields:
    description:
