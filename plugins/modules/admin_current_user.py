...
DOCUMENTATION = """
module: admin_current_user
short_description: Handle resource of type admin_current_user
description: Handle resource of type admin_current_user
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/rbac-e/api/v1/admin/current-user".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/rbac-e/api/v1/admin/current-user".format(
        **params
