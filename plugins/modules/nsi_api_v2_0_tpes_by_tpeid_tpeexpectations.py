...
DOCUMENTATION = """
module: nsi_api_v2_0_tpes_by_tpeid_tpeexpectations
short_description: Handle resource of type nsi_api_v2_0_tpes_by_tpeid_tpeexpectations
description: Handle resource of type nsi_api_v2_0_tpes_by_tpeid_tpeexpectations
options:
  state:
    choices:
    - get
