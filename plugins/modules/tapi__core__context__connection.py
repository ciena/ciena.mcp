...
DOCUMENTATION = """
module: tapi__core__context__connection
short_description: Handle resource of type tapi__core__context__connection
description: Handle resource of type tapi__core__context__connection
options:
  limit:
    description:
