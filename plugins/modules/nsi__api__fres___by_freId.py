...
DOCUMENTATION = """
module: nsi__api__fres___by_freId
short_description: Handle resource of type nsi__api__fres___by_freId
description: Handle resource of type nsi__api__fres___by_freId
options:
  data:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["freId"] = {
        "type": "str",
        "operationIds": ["delete", "get", "patch", "put"],
    }
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/fres/{freId}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/fres/{freId}".format(**params) + gen_args(
...
async def _patch(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/fres/{freId}".format(**params)
