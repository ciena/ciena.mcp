...
DOCUMENTATION = """
module: nsi_api_physicallocations_by_id
short_description: Handle resource of type nsi_api_physicallocations_by_id
description: Handle resource of type nsi_api_physicallocations_by_id
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/physicalLocations/{id}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/physicalLocations/{id}".format(
        **params
