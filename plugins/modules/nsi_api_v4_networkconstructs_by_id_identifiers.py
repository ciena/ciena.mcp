...
DOCUMENTATION = """
module: nsi_api_v4_networkconstructs_by_id_identifiers
short_description: Handle resource of type nsi_api_v4_networkconstructs_by_id_identifiers
description: Handle resource of type nsi_api_v4_networkconstructs_by_id_identifiers
options:
  id:
    description:
    - The NC id
...
def url(params):
    return (
        "https://{mcp_hostname}/nsi/api/v4/networkConstructs/{id}/identifiers".format(
            **params
        )
    )
