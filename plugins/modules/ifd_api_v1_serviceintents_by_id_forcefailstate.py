...
DOCUMENTATION = """
module: ifd_api_v1_serviceintents_by_id_forcefailstate
short_description: Handle resource of type ifd_api_v1_serviceintents_by_id_forcefailstate
description: Handle resource of type ifd_api_v1_serviceintents_by_id_forcefailstate
options:
  id:
    description:
...
def url(params):
    return (
        "https://{mcp_hostname}/ifd/api/v1/serviceIntents/{id}/forceFailState".format(
            **params
        )
    )
