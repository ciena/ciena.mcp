...
DOCUMENTATION = """
module: nsi_api_v3_equipment_by_equipmentid
short_description: Handle resource of type nsi_api_v3_equipment_by_equipmentid
description: Handle resource of type nsi_api_v3_equipment_by_equipmentid
options:
  data:
    description:
    - The equipment data
  ...
  include:
    ...
    - '(Optional) List of comma separated resources to be side-loaded. The allowed
      values are: expectations, equipmentPlanned, equipmentDiscovered.'
    - Used by I(state=['get'])
    type: str
  included:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/equipment/{equipmentId}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/equipment/{equipmentId}".format(
        **params
...
async def _put(params, session):
    accepted_fields = ["data", "equipmentId", "included", "meta"]
    spec = {}
