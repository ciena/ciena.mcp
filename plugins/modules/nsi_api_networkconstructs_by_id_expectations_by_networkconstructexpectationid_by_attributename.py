...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid_by_attributename
short_description: Handle resource of type nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid_by_attributename
description: Handle resource of type nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid_by_attributename
options:
  attributeName:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations/{networkConstructExpectationId}/{attributeName}".format(
        **params
    )
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations/{networkConstructExpectationId}/{attributeName}".format(
        **params
    ) + gen_args(
