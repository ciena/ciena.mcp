...
DOCUMENTATION = """
module: nsi__api__fres___by_freId__frePlanned
short_description: Handle resource of type nsi__api__fres___by_freId__frePlanned
description: Handle resource of type nsi__api__fres___by_freId__frePlanned
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/fres/{freId}/frePlanned".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/fres/{freId}/frePlanned".format(
        **params
...
async def _patch(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/fres/{freId}/frePlanned".format(**params)
