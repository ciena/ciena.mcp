...
DOCUMENTATION = """
module: nsi_api_v6_networkconstructs
short_description: Handle resource of type nsi_api_v6_networkconstructs
description: Handle resource of type nsi_api_v6_networkconstructs
options:
  concrete:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v6/networkConstructs".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v6/networkConstructs".format(
        **params
