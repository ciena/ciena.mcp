...
DOCUMENTATION = """
module: nsi__api__fres___by_freId__operations___by_operation
short_description: Handle resource of type nsi__api__fres___by_freId__operations___by_operation
description: Handle resource of type nsi__api__fres___by_freId__operations___by_operation
options:
  freId:
    description:
    - FRE identifier
...
def prepare_argument_spec():
    ...
    argument_spec["operation"] = {
        "type": "str",
        "choices": ["makeCurrentToHome", "regroom", "revert"],
        "operationIds": ["put"],
    }
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/fres/{freId}/operations/{operation}".format(
        **params
    )
...
async def _put(params, session):
    _url = "https://{mcp_hostname}/nsi/api/fres/{freId}/operations/{operation}".format(
        **params
