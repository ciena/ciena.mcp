...
DOCUMENTATION = """
module: tapi_core_context_physical_context_equipmentholder
short_description: Handle resource of type tapi_core_context_physical_context_equipmentholder
description: Handle resource of type tapi_core_context_physical_context_equipmentholder
options:
  limit:
    description:
