...
DOCUMENTATION = """
module: tapi_data_context_connectivity_context_connection
short_description: Handle resource of type tapi_data_context_connectivity_context_connection
description: Handle resource of type tapi_data_context_connectivity_context_connection
options:
  page[number]:
    description:
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/connectivity-context/connection/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/connectivity-context/connection/".format(
        **params
    ) + gen_args(
