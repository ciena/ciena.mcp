...
DOCUMENTATION = """
module: ifd_api_v1_serviceintents_getfeasibleroute
short_description: Handle resource of type ifd_api_v1_serviceintents_getfeasibleroute
description: Handle resource of type ifd_api_v1_serviceintents_getfeasibleroute
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/v1/serviceIntents/getFeasibleRoute".format(
        **params
    )
