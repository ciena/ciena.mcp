...
DOCUMENTATION = """
module: commissioning_api_v1_ipsubnet
short_description: Handle resource of type commissioning_api_v1_ipsubnet
description: Handle resource of type commissioning_api_v1_ipsubnet
options:
  ospfArea:
    description:
    - ospfArea of the Shelf
    - Required with I(state=['delete', 'post'])
    - Used by I(state=['delete', 'post'])
    type: str
  shelfIP:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["usage"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["subnetId"] = {"type": "str", "operationIds": ["delete"]}
    argument_spec["state"] = {"type": "str", "choices": ["delete", "get", "post"]}
    argument_spec["shelfIP"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["ospfArea"] = {"type": "str", "operationIds": ["delete", "post"]}
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/ipsubnet/".format(**params)
...
async def _delete(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/commissioning/api/v1/ipsubnet/".format(
        **params
...
async def _post(params, session):
    accepted_fields = ["ospfArea", "shelfIP", "usage"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
