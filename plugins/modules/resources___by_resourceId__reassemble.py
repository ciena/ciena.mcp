...
DOCUMENTATION = """
module: resources___by_resourceId__reassemble
short_description: Handle resource of type resources___by_resourceId__reassemble
description: Handle resource of type resources___by_resourceId__reassemble
options:
  resourceId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/reassemble".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/reassemble".format(
        **params
    ) + gen_args(
