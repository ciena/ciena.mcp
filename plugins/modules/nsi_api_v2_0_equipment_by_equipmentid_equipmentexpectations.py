...
DOCUMENTATION = """
module: nsi_api_v2_0_equipment_by_equipmentid_equipmentexpectations
short_description: Handle resource of type nsi_api_v2_0_equipment_by_equipmentid_equipmentexpectations
description: Handle resource of type nsi_api_v2_0_equipment_by_equipmentid_equipmentexpectations
options:
  equipmentId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2_0/equipment/{equipmentId}/equipmentExpectations".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v2_0/equipment/{equipmentId}/equipmentExpectations".format(
        **params
    ) + gen_args(
