...
DOCUMENTATION = """
module: configmgmt_api_v1_upgrade_status
short_description: Handle resource of type configmgmt_api_v1_upgrade_status
description: Handle resource of type configmgmt_api_v1_upgrade_status
options:
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/upgrade/status".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/upgrade/status".format(
        **params
