...
DOCUMENTATION = """
module: nsi_api_fres_by_freid_operations_by_operation
short_description: Handle resource of type nsi_api_fres_by_freid_operations_by_operation
description: Handle resource of type nsi_api_fres_by_freid_operations_by_operation
options:
  freId:
    description:
    - FRE identifier
...
async def _put(params, session):
    accepted_fields = ["freId", "operation"]
    spec = {}
