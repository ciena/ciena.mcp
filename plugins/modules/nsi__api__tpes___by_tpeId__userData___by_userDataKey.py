...
DOCUMENTATION = """
module: nsi__api__tpes___by_tpeId__userData___by_userDataKey
short_description: Handle resource of type nsi__api__tpes___by_tpeId__userData___by_userDataKey
description: Handle resource of type nsi__api__tpes___by_tpeId__userData___by_userDataKey
options:
  body:
    description:
    - The desired userData value Required with I(state=['put'])
    type: str
  state:
    choices:
    - delete
  ...
  userDataKey:
    description:
    - The userData key that will be used to delete the potential value
    type: str
author:
- Jeff Groom
version_added: 1.0.0
...
def prepare_argument_spec():
    ...
    argument_spec["userDataKey"] = {"type": "str", "operationIds": ["delete", "put"]}
    argument_spec["tpeId"] = {"type": "str", "operationIds": ["delete", "put"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/tpes/{tpeId}/userData/{userDataKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/tpes/{tpeId}/userData/{userDataKey}".format(
        **params
