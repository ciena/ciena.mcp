...
DOCUMENTATION = """
module: ifd_api_v1_serviceintents_by_id_route
short_description: Handle resource of type ifd_api_v1_serviceintents_by_id_route
description: Handle resource of type ifd_api_v1_serviceintents_by_id_route
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/v1/serviceIntents/{id}/route".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/ifd/api/v1/serviceIntents/{id}/route".format(
        **params
