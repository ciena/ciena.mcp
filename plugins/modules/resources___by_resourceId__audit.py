...
DOCUMENTATION = """
module: resources___by_resourceId__audit
short_description: Handle resource of type resources___by_resourceId__audit
description: Handle resource of type resources___by_resourceId__audit
options:
  resourceId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/audit".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/audit".format(
        **params
    ) + gen_args(
