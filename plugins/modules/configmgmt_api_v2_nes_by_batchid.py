...
DOCUMENTATION = """
module: configmgmt_api_v2_nes_by_batchid
short_description: Handle resource of type configmgmt_api_v2_nes_by_batchid
description: Handle resource of type configmgmt_api_v2_nes_by_batchid
options:
  batchId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v2/nes/{batchId}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v2/nes/{batchId}".format(
        **params
