...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id_expectations_by_expectationid
short_description: Handle resource of type nsi_api_networkconstructs_by_id_expectations_by_expectationid
description: Handle resource of type nsi_api_networkconstructs_by_id_expectations_by_expectationid
options:
  expectationId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations/{expectationId}".format(
        **params
    )
...
async def _patch(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations/{expectationId}".format(
        **params
    ) + gen_args(
