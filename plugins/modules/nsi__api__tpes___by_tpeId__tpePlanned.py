...
DOCUMENTATION = """
module: nsi__api__tpes___by_tpeId__tpePlanned
short_description: Handle resource of type nsi__api__tpes___by_tpeId__tpePlanned
description: Handle resource of type nsi__api__tpes___by_tpeId__tpePlanned
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/tpes/{tpeId}/tpePlanned".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/tpes/{tpeId}/tpePlanned".format(
        **params
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/tpes/{tpeId}/tpePlanned".format(**params)
