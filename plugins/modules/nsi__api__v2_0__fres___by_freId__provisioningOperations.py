...
DOCUMENTATION = """
module: nsi__api__v2_0__fres___by_freId__provisioningOperations
short_description: Handle resource of type nsi__api__v2_0__fres___by_freId__provisioningOperations
description: Handle resource of type nsi__api__v2_0__fres___by_freId__provisioningOperations
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2_0/fres/{freId}/provisioningOperations".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v2_0/fres/{freId}/provisioningOperations".format(
        **params
    )
