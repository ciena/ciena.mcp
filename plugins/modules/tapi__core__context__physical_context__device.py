...
DOCUMENTATION = """
module: tapi__core__context__physical_context__device
short_description: Handle resource of type tapi__core__context__physical_context__device
description: Handle resource of type tapi__core__context__physical_context__device
options:
  limit:
    description:
...
def url(params):
    return "https://{mcp_hostname}/tapi/core/context/physical-context/device/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/core/context/physical-context/device/".format(
        **params
