...
DOCUMENTATION = """
module: nsi_api_v3_tpes_by_tpeid_tpeplanned
short_description: Handle resource of type nsi_api_v3_tpes_by_tpeid_tpeplanned
description: Handle resource of type nsi_api_v3_tpes_by_tpeid_tpeplanned
options:
  data:
    description:
