...
DOCUMENTATION = """
module: nsi_api_tpes_by_tpeid_expectations
short_description: Handle resource of type nsi_api_tpes_by_tpeid_expectations
description: Handle resource of type nsi_api_tpes_by_tpeid_expectations
options:
  data:
    description:
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/tpes/{tpeId}/expectations".format(
        **params
