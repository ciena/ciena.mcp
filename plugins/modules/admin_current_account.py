...
DOCUMENTATION = """
module: admin_current_account
short_description: Handle resource of type admin_current_account
description: Handle resource of type admin_current_account
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/rbac-e/api/v1/admin/current-account".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/rbac-e/api/v1/admin/current-account".format(
        **params
