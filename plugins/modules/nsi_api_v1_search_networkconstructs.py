...
DOCUMENTATION = """
module: nsi_api_v1_search_networkconstructs
short_description: Handle resource of type nsi_api_v1_search_networkconstructs
description: Handle resource of type nsi_api_v1_search_networkconstructs
options:
  associationState:
    description:
  ...
  displayResourceState:
    description:
    - '(Optional) List of networkConstruct syncStates. The allowed values are: root,
  ...
  displaySyncState:
    ...
    - '(Optional) List of networkConstruct syncStates. The allowed values are: planned,
      notSynchronized, synchronizing, synchronized, failed, pending, deleting, timeout'
    - Used by I(state=['get'])
    type: str
  endDateMax:
    description:
  ...
  geoDistanceQuery:
    description:
    - '(Optional) Filters on distance from a specified location; the Geo distance
      query is formatted as follows: <distance>:<latitude>:<longitude>'
    - Used by I(state=['get'])
    type: str
  id:
    description:
  ...
  syncState:
    ...
    - '(Optional) List of networkConstruct syncStates. The allowed values are: notSynchronized,
      synchronizing, synchronized, failed, timeout, aborted, deleting, deleteFailed'
    - Used by I(state=['get'])
    type: str
  tags:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["geoDistanceQuery"] = {"type": "str", "operationIds": ["get"]}
    ...
    argument_spec["displayResourceState"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["displayName"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["displayInventorySyncFailureReason"] = {
        "type": "str",
        "operationIds": ["get"],
    }
    argument_spec["displayAssociationState"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v1/search/networkConstructs".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v1/search/networkConstructs".format(
        **params
