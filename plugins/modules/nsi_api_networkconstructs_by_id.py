...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id
short_description: Handle resource of type nsi_api_networkconstructs_by_id
description: Handle resource of type nsi_api_networkconstructs_by_id
options:
  fields:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}".format(
        **params
