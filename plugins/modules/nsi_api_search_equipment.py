...
DOCUMENTATION = """
module: nsi_api_search_equipment
short_description: Handle resource of type nsi_api_search_equipment
description: Handle resource of type nsi_api_search_equipment
options:
  availabilityState:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/search/equipment".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/search/equipment".format(
        **params
