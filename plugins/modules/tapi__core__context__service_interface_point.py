...
DOCUMENTATION = """
module: tapi__core__context__service_interface_point
short_description: Handle resource of type tapi__core__context__service_interface_point
description: Handle resource of type tapi__core__context__service_interface_point
options:
  limit:
    description:
...
def url(params):
    return "https://{mcp_hostname}/tapi/core/context/service-interface-point/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/core/context/service-interface-point/".format(
        **params
