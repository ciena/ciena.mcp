...
DOCUMENTATION = """
module: nsi_api_equipment_by_equipmentid_expectations_by_equipmentexpectationid
short_description: Handle resource of type nsi_api_equipment_by_equipmentid_expectations_by_equipmentexpectationid
description: Handle resource of type nsi_api_equipment_by_equipmentid_expectations_by_equipmentexpectationid
options:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/equipment/{equipmentId}/expectations/{equipmentExpectationId}".format(
        **params
    )
...
async def _patch(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/equipment/{equipmentId}/expectations/{equipmentExpectationId}".format(
        **params
    ) + gen_args(
