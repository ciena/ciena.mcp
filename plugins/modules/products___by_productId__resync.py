...
DOCUMENTATION = """
module: products___by_productId__resync
short_description: Handle resource of type products___by_productId__resync
description: Handle resource of type products___by_productId__resync
options:
  full:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/products/{productId}/resync".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/products/{productId}/resync".format(
        **params
    ) + gen_args(
