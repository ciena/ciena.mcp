...
DOCUMENTATION = """
module: resources___by_resourceId__dependents
short_description: Handle resource of type resources___by_resourceId__dependents
description: Handle resource of type resources___by_resourceId__dependents
options:
  applicationSliceId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/dependents".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/dependents".format(
        **params
    ) + gen_args(
