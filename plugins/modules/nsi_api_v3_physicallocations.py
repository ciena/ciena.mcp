...
DOCUMENTATION = """
module: nsi_api_v3_physicallocations
short_description: Handle resource of type nsi_api_v3_physicallocations
description: Handle resource of type nsi_api_v3_physicallocations
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/physicalLocations".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/physicalLocations".format(
        **params
