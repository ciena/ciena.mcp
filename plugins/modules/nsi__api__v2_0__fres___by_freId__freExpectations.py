...
DOCUMENTATION = """
module: nsi__api__v2_0__fres___by_freId__freExpectations
short_description: Handle resource of type nsi__api__v2_0__fres___by_freId__freExpectations
description: Handle resource of type nsi__api__v2_0__fres___by_freId__freExpectations
options:
  freId:
    description:
    - FRE identifier
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2_0/fres/{freId}/freExpectations".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v2_0/fres/{freId}/freExpectations".format(
        **params
