...
DOCUMENTATION = """
module: nsi_api_tpes_by_tpeid_tpeexpectations
short_description: Handle resource of type nsi_api_tpes_by_tpeid_tpeexpectations
description: Handle resource of type nsi_api_tpes_by_tpeid_tpeexpectations
options:
  state:
    choices:
    - get
