...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id_identifiers_by_identifierkey
short_description: Handle resource of type nsi_api_networkconstructs_by_id_identifiers_by_identifierkey
description: Handle resource of type nsi_api_networkconstructs_by_id_identifiers_by_identifierkey
options:
  id:
    description:
    - Identifier of the Network Construct under which to create or update the identifier
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/identifiers/{identifierKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/identifiers/{identifierKey}".format(
        **params
    ) + gen_args(
