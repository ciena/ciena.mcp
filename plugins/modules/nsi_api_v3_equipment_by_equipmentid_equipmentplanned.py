...
DOCUMENTATION = """
module: nsi_api_v3_equipment_by_equipmentid_equipmentplanned
short_description: Handle resource of type nsi_api_v3_equipment_by_equipmentid_equipmentplanned
description: Handle resource of type nsi_api_v3_equipment_by_equipmentid_equipmentplanned
options:
  data:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["equipmentId"] = {
        "type": "str",
        "operationIds": ["get", "patch", "put"],
    }
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/equipment/{equipmentId}/equipmentPlanned".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/equipment/{equipmentId}/equipmentPlanned".format(
        **params
    ) + gen_args(
...
async def _patch(params, session):
    accepted_fields = ["equipmentId", "operations"]
    spec = {}
...
async def _put(params, session):
    accepted_fields = ["data", "equipmentId", "included"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
