...
DOCUMENTATION = """
module: nsi_api_fres_by_freid_expectations
short_description: Handle resource of type nsi_api_fres_by_freid_expectations
description: Handle resource of type nsi_api_fres_by_freid_expectations
options:
  data:
    description:
