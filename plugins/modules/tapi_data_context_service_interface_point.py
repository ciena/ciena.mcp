...
DOCUMENTATION = """
module: tapi_data_context_service_interface_point
short_description: Handle resource of type tapi_data_context_service_interface_point
description: Handle resource of type tapi_data_context_service_interface_point
options:
  page[number]:
    description:
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/service-interface-point/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/service-interface-point/".format(
        **params
