...
short_description: Handle resource of type admin_resources
description: Handle resource of type admin_resources
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/rbac-e/api/v1/admin/resources".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/rbac-e/api/v1/admin/resources".format(
        **params
