...
DOCUMENTATION = """
module: nsi_api_physicallocations
short_description: Handle resource of type nsi_api_physicallocations
description: Handle resource of type nsi_api_physicallocations
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/physicalLocations".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/physicalLocations".format(
        **params
