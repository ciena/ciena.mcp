...
DOCUMENTATION = """
module: rest_permission
short_description: Handle resource of type rest_permission
description: Handle resource of type rest_permission
options:
  Mac:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["token"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["state"] = {"type": "str", "choices": ["post"]}
    argument_spec["path"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["method"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["authType"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["Mac"] = {"type": "str", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/rbac-e/api/v1/rest/permission".format(**params)
...
async def _post(params, session):
    accepted_fields = ["Mac", "authType", "method", "path", "token"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/rbac-e/api/v1/rest/permission".format(
        **params
