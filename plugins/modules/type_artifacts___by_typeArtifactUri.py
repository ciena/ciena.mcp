...
DOCUMENTATION = """
module: type_artifacts___by_typeArtifactUri
short_description: Handle resource of type type_artifacts___by_typeArtifactUri
description: Handle resource of type type_artifacts___by_typeArtifactUri
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/type-artifacts/{typeArtifactUri}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/type-artifacts/{typeArtifactUri}".format(
        **params
    ) + gen_args(
