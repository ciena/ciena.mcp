...
DOCUMENTATION = """
module: sharing_permissions___by_sharingPermissionId
short_description: Handle resource of type sharing_permissions___by_sharingPermissionId
description: Handle resource of type sharing_permissions___by_sharingPermissionId
options:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/sharing-permissions/{sharingPermissionId}".format(
        **params
    )
