...
DOCUMENTATION = """
module: discovery__api__managementSessions___by_sessionId
short_description: Handle resource of type discovery__api__managementSessions___by_sessionId
description: Handle resource of type discovery__api__managementSessions___by_sessionId
options:
  operations:
    description: []
    type: list
...
def prepare_argument_spec():
    ...
    argument_spec["state"] = {"type": "str", "choices": ["delete", "get", "patch"]}
    argument_spec["sessionId"] = {
        "type": "str",
        "operationIds": ["delete", "get", "patch"],
    }
...
def url(params):
    return "https://{mcp_hostname}/discovery/api/managementSessions/{sessionId}".format(
        **params
    )
