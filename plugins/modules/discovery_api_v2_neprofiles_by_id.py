...
DOCUMENTATION = """
module: discovery_api_v2_neprofiles_by_id
short_description: Handle resource of type discovery_api_v2_neprofiles_by_id
description: Handle resource of type discovery_api_v2_neprofiles_by_id
options:
  data:
    description:
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/discovery/api/v2/neprofiles/{id}".format(
        **params
