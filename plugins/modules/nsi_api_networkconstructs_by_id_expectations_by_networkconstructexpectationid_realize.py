...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid_realize
short_description: Handle resource of type nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid_realize
description: Handle resource of type nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid_realize
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations/{networkConstructExpectationId}/realize".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations/{networkConstructExpectationId}/realize".format(
        **params
    ) + gen_args(
