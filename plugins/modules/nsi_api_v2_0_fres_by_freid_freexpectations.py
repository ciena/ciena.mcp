...
DOCUMENTATION = """
module: nsi_api_v2_0_fres_by_freid_freexpectations
short_description: Handle resource of type nsi_api_v2_0_fres_by_freid_freexpectations
description: Handle resource of type nsi_api_v2_0_fres_by_freid_freexpectations
options:
  freId:
    description:
    - FRE identifier
