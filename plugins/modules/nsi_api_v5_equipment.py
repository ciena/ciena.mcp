...
DOCUMENTATION = """
module: nsi_api_v5_equipment
short_description: Handle resource of type nsi_api_v5_equipment
description: Handle resource of type nsi_api_v5_equipment
options:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v5/equipment".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v5/equipment".format(**params) + gen_args(
