...
short_description: Handle resource of type audit_configuration
description: Handle resource of type audit_configuration
options:
  enable:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["enable"] = {"type": "bool", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/rbac-e/api/v1/audit/configuration".format(**params)
...
async def _post(params, session):
    accepted_fields = ["enable"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/rbac-e/api/v1/audit/configuration".format(
        **params
