...
DOCUMENTATION = """
module: configmgmt_api_v1_batches_by_batchid
short_description: Handle resource of type configmgmt_api_v1_batches_by_batchid
description: Handle resource of type configmgmt_api_v1_batches_by_batchid
options:
  attributes:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["batchId"] = {"type": "str", "operationIds": ["get", "put"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/batches/{batchId}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/batches/{batchId}".format(
        **params
...
async def _put(params, session):
    accepted_fields = ["attributes", "batchId", "id", "type"]
    spec = {}
