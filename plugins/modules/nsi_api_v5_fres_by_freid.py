...
DOCUMENTATION = """
module: nsi_api_v5_fres_by_freid
short_description: Handle resource of type nsi_api_v5_fres_by_freid
description: Handle resource of type nsi_api_v5_fres_by_freid
options:
  fields:
    description:
