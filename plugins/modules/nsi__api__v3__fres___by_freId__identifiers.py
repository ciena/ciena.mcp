...
DOCUMENTATION = """
module: nsi__api__v3__fres___by_freId__identifiers
short_description: Handle resource of type nsi__api__v3__fres___by_freId__identifiers
description: Handle resource of type nsi__api__v3__fres___by_freId__identifiers
options:
  freId:
    description:
    - The FRE id
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/fres/{freId}/identifiers".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/fres/{freId}/identifiers".format(
        **params
