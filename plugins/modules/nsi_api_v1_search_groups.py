...
DOCUMENTATION = """
module: nsi_api_v1_search_groups
short_description: Handle resource of type nsi_api_v1_search_groups
description: Handle resource of type nsi_api_v1_search_groups
options:
  fields:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v1/search/groups".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v1/search/groups".format(
        **params
