...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id_expectations
short_description: Handle resource of type nsi_api_networkconstructs_by_id_expectations
description: Handle resource of type nsi_api_networkconstructs_by_id_expectations
options:
  attributes:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations".format(
        **params
