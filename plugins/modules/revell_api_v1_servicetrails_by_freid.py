...
DOCUMENTATION = """
module: revell_api_v1_servicetrails_by_freid
short_description: Handle resource of type revell_api_v1_servicetrails_by_freid
description: Handle resource of type revell_api_v1_servicetrails_by_freid
options:
  freId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/revell/api/v1/serviceTrails/{freId}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/revell/api/v1/serviceTrails/{freId}".format(
        **params
