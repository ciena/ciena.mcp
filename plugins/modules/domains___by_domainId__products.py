...
DOCUMENTATION = """
module: domains___by_domainId__products
short_description: Handle resource of type domains___by_domainId__products
description: Handle resource of type domains___by_domainId__products
options:
  domainId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/domains/{domainId}/products".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/domains/{domainId}/products".format(
        **params
    ) + gen_args(
