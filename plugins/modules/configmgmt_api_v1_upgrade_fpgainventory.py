...
DOCUMENTATION = """
module: configmgmt_api_v1_upgrade_fpgainventory
short_description: Handle resource of type configmgmt_api_v1_upgrade_fpgainventory
description: Handle resource of type configmgmt_api_v1_upgrade_fpgainventory
options:
  networkConstructName:
    description:
    - Networkconstruct Name for which FPGA Inventory to be retrieved.
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/upgrade/fpgaInventory".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/upgrade/fpgaInventory".format(
        **params
