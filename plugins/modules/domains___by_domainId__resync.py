...
DOCUMENTATION = """
module: domains___by_domainId__resync
short_description: Handle resource of type domains___by_domainId__resync
description: Handle resource of type domains___by_domainId__resync
options:
  domainId:
    description:
