...
DOCUMENTATION = """
module: tag_keys___by_tagKey__tag_values
short_description: Handle resource of type tag_keys___by_tagKey__tag_values
description: Handle resource of type tag_keys___by_tagKey__tag_values
options:
  description:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}/tag-values".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}/tag-values".format(
        **params
    ) + gen_args(
