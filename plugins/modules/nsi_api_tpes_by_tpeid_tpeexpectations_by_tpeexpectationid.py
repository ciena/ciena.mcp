...
DOCUMENTATION = """
module: nsi_api_tpes_by_tpeid_tpeexpectations_by_tpeexpectationid
short_description: Handle resource of type nsi_api_tpes_by_tpeid_tpeexpectations_by_tpeexpectationid
description: Handle resource of type nsi_api_tpes_by_tpeid_tpeexpectations_by_tpeexpectationid
options:
  state:
    choices:
    - delete
