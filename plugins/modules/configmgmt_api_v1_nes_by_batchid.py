...
DOCUMENTATION = """
module: configmgmt_api_v1_nes_by_batchid
short_description: Handle resource of type configmgmt_api_v1_nes_by_batchid
description: Handle resource of type configmgmt_api_v1_nes_by_batchid
options:
  batchId:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["batchId"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/nes/{batchId}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/nes/{batchId}".format(
        **params
