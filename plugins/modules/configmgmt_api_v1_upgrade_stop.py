...
DOCUMENTATION = """
module: configmgmt_api_v1_upgrade_stop
short_description: Handle resource of type configmgmt_api_v1_upgrade_stop
description: Handle resource of type configmgmt_api_v1_upgrade_stop
options:
...
def prepare_argument_spec():
    ...
    argument_spec["networkConstructNames"] = {"type": "list", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/upgrade/stop".format(**params)
...
async def _post(params, session):
    accepted_fields = ["networkConstructNames"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/configmgmt/api/v1/upgrade/stop".format(
        **params
