...
DOCUMENTATION = """
module: tapi_data_context_stream_context_available_stream
short_description: Handle resource of type tapi_data_context_stream_context_available_stream
description: Handle resource of type tapi_data_context_stream_context_available_stream
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/stream-context/available-stream/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/stream-context/available-stream/".format(
        **params
    ) + gen_args(
