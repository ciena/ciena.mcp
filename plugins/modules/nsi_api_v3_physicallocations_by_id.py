...
DOCUMENTATION = """
module: nsi_api_v3_physicallocations_by_id
short_description: Handle resource of type nsi_api_v3_physicallocations_by_id
description: Handle resource of type nsi_api_v3_physicallocations_by_id
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/physicalLocations/{id}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/physicalLocations/{id}".format(
        **params
