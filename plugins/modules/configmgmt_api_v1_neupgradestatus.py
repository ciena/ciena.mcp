...
DOCUMENTATION = """
module: configmgmt_api_v1_neupgradestatus
short_description: Handle resource of type configmgmt_api_v1_neupgradestatus
description: Handle resource of type configmgmt_api_v1_neupgradestatus
options:
  ncid:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["ncid", "operationtype"]
...
def prepare_argument_spec():
    ...
    argument_spec["operationtype"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/neUpgradeStatus".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/neUpgradeStatus".format(
        **params
