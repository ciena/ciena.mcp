...
DOCUMENTATION = """
module: commissioning_api_v1_uap_6500_3
short_description: Handle resource of type commissioning_api_v1_uap_6500_3
description: Handle resource of type commissioning_api_v1_uap_6500_3
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/uap-6500-3/".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/commissioning/api/v1/uap-6500-3/".format(
        **params
