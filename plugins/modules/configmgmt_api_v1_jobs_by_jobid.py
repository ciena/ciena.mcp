...
DOCUMENTATION = """
module: configmgmt_api_v1_jobs_by_jobid
short_description: Handle resource of type configmgmt_api_v1_jobs_by_jobid
description: Handle resource of type configmgmt_api_v1_jobs_by_jobid
options:
  body:
    description:
    - Update config job execution user input attributes as JSON wrapper object
    - Required with I(state=['patch'])
    - Used by I(state=['patch'])
    type: str
  jobId:
    description:
    - The job execution id used for current status of a config job lookup
...
def prepare_argument_spec():
    ...
    argument_spec["jobId"] = {"type": "str", "operationIds": ["delete", "get", "patch"]}
    argument_spec["body"] = {"type": "str", "operationIds": ["patch"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/jobs/{jobId}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/jobs/{jobId}".format(
        **params
