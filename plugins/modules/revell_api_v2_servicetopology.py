...
DOCUMENTATION = """
module: revell_api_v2_servicetopology
short_description: Handle resource of type revell_api_v2_servicetopology
description: Handle resource of type revell_api_v2_servicetopology
options:
  state:
    choices:
    - post
...
def url(params):
    return "https://{mcp_hostname}/revell/api/v2/serviceTopology/".format(**params)
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/revell/api/v2/serviceTopology/".format(
        **params
