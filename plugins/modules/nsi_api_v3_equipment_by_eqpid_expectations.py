...
DOCUMENTATION = """
module: nsi_api_v3_equipment_by_eqpid_expectations
short_description: Handle resource of type nsi_api_v3_equipment_by_eqpid_expectations
description: Handle resource of type nsi_api_v3_equipment_by_eqpid_expectations
options:
  data:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["eqpId"] = {"type": "str", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/equipment/{eqpId}/expectations".format(
        **params
    )
...
async def _post(params, session):
    accepted_fields = ["data", "eqpId", "included"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v3/equipment/{eqpId}/expectations".format(
        **params
