...
DOCUMENTATION = """
module: nsi__api__fres___by_freId__expectations
short_description: Handle resource of type nsi__api__fres___by_freId__expectations
description: Handle resource of type nsi__api__fres___by_freId__expectations
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/fres/{freId}/expectations".format(**params)
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/fres/{freId}/expectations".format(**params)
