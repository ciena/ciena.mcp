...
DOCUMENTATION = """
module: nsi_api_v4_networkconstructs_by_id_expectations_by_expid
short_description: Handle resource of type nsi_api_v4_networkconstructs_by_id_expectations_by_expid
description: Handle resource of type nsi_api_v4_networkconstructs_by_id_expectations_by_expid
options:
  attributes:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["relationships"] = {"type": "dict", "operationIds": ["put"]}
    argument_spec["id"] = {"type": "str", "operationIds": ["put", "put"]}
    argument_spec["expId"] = {"type": "str", "operationIds": ["put"]}
    argument_spec["attributes"] = {"type": "dict", "operationIds": ["put"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v4/networkConstructs/{id}/expectations/{expId}".format(
        **params
    )
...
async def _put(params, session):
    accepted_fields = ["attributes", "expId", "id", "relationships", "type"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v4/networkConstructs/{id}/expectations/{expId}".format(
        **params
    ) + gen_args(
