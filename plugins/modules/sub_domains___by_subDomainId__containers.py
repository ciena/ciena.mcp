...
DOCUMENTATION = """
module: sub_domains___by_subDomainId__containers
short_description: Handle resource of type sub_domains___by_subDomainId__containers
description: Handle resource of type sub_domains___by_subDomainId__containers
options:
  limit:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/containers".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/sub-domains/{subDomainId}/containers".format(
        **params
    ) + gen_args(
