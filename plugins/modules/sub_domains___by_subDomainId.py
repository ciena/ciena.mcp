...
DOCUMENTATION = """
module: sub_domains___by_subDomainId
short_description: Handle resource of type sub_domains___by_subDomainId
description: Handle resource of type sub_domains___by_subDomainId
options:
  applicationSlices:
    description:
