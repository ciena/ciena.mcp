...
DOCUMENTATION = """
module: resources___by_resourceId__resync
short_description: Handle resource of type resources___by_resourceId__resync
description: Handle resource of type resources___by_resourceId__resync
options:
  full:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/resync".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/resync".format(
        **params
    ) + gen_args(
