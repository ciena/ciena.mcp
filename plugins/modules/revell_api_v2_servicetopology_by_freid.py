...
DOCUMENTATION = """
module: revell_api_v2_servicetopology_by_freid
short_description: Handle resource of type revell_api_v2_servicetopology_by_freid
description: Handle resource of type revell_api_v2_servicetopology_by_freid
options:
  freId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/revell/api/v2/serviceTopology/{freId}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/revell/api/v2/serviceTopology/{freId}".format(
        **params
