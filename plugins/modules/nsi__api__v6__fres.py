...
DOCUMENTATION = """
module: nsi__api__v6__fres
short_description: Handle resource of type nsi__api__v6__fres
description: Handle resource of type nsi__api__v6__fres
options:
  childFreId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v6/fres".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v6/fres".format(**params) + gen_args(
