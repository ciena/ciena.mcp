...
DOCUMENTATION = """
module: nsi_api_v3_fres_by_freid_discovered_validate
short_description: Handle resource of type nsi_api_v3_fres_by_freid_discovered_validate
description: Handle resource of type nsi_api_v3_fres_by_freid_discovered_validate
options:
  freId:
    description:
    - FRE identifier
