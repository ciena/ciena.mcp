...
DOCUMENTATION = """
module: nsi_api_v3_physicallocations_by_id_identifiers_by_identifierkey
short_description: Handle resource of type nsi_api_v3_physicallocations_by_id_identifiers_by_identifierkey
description: Handle resource of type nsi_api_v3_physicallocations_by_id_identifiers_by_identifierkey
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/physicalLocations/{id}/identifiers/{identifierKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/physicalLocations/{id}/identifiers/{identifierKey}".format(
        **params
    ) + gen_args(
