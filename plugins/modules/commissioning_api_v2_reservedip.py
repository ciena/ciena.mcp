...
DOCUMENTATION = """
module: commissioning_api_v2_reservedip
short_description: Handle resource of type commissioning_api_v2_reservedip
description: Handle resource of type commissioning_api_v2_reservedip
options:
  shelfNumber:
    description:
    - Shelf Number
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v2/reservedIP/".format(**params)
...
async def _delete(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/commissioning/api/v2/reservedIP/".format(
        **params
