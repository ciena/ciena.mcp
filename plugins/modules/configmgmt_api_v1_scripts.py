...
DOCUMENTATION = """
module: configmgmt_api_v1_scripts
short_description: Handle resource of type configmgmt_api_v1_scripts
description: Handle resource of type configmgmt_api_v1_scripts
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/scripts".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/scripts".format(
        **params
