...
DOCUMENTATION = """
module: relationships___by_relationshipId
short_description: Handle resource of type relationships___by_relationshipId
description: Handle resource of type relationships___by_relationshipId
options:
  relationshipId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/relationships/{relationshipId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/relationships/{relationshipId}".format(
        **params
    ) + gen_args(
