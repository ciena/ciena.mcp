...
DOCUMENTATION = """
module: resource_types___by_resourceTypeId
short_description: Handle resource of type resource_types___by_resourceTypeId
description: Handle resource of type resource_types___by_resourceTypeId
options:
  resourceTypeId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resource-types/{resourceTypeId}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resource-types/{resourceTypeId}".format(
        **params
    ) + gen_args(
