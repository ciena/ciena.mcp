...
DOCUMENTATION = """
module: commissioning_api_v1_policydefaults
short_description: Handle resource of type commissioning_api_v1_policydefaults
description: Handle resource of type commissioning_api_v1_policydefaults
options:
  data:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["id"] = {
        "type": "str",
        "operationIds": ["delete", "get", "post", "put"],
    }
    argument_spec["data"] = {"type": "dict", "operationIds": ["post", "put"]}
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/policyDefaults/".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/commissioning/api/v1/policyDefaults/".format(
        **params
