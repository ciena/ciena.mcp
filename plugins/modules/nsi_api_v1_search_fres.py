...
DOCUMENTATION = """
module: nsi_api_v1_search_fres
short_description: Handle resource of type nsi_api_v1_search_fres
description: Handle resource of type nsi_api_v1_search_fres
options:
  active:
    choices:
    - 'false'
  ...
  layerRate:
    ...
    - 'FRE layer rates in comma separated list The allowed values are: ETHERNET, OTU1,
      OTU2, OTU2e, OTU3, OTU4, OTUCn, OTSi, OMS, OS, PHY, OTS, FICON, FC, ODU, ODU0,
      ODU1, ODU2, ODU2e, ODU3, ODU4, ODUCn, DSR, DSR_10GE, DSR_100GE, DSR_ETHERNET,
  ...
  metaDataFields:
    ...
    - 'MetaData to be included. The allowed values are: layerRate, layerRateQualifier,
      ...
      customerName, domainTypes, resilienceLevel, directionality'
    - Used by I(state=['get'])
    type: str
  metaDataQualifiers:
    description:
  ...
  serviceClass:
    ...
    - '(Optional) Allow filtering on the FRE service class. This parameter accepts
      ...
      Fiber, SNC , OSRP Link, OSRP Line, SNCP, ICL'
    - Used by I(state=['get'])
    type: str
  signalContentType:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["serviceClass"] = {"type": "str", "operationIds": ["get"]}
    ...
    argument_spec["resilienceLevel"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["partitionFreIds"] = {"type": "str", "operationIds": ["get"]}
    ...
    argument_spec["networkConstruct_idQualifier"] = {
        "type": "str",
        "choices": ["and", "or"],
        "operationIds": ["get"],
    }
    ...
    argument_spec["domainTypes"] = {"type": "str", "operationIds": ["get"]}
    ...
    argument_spec["decomposedFreIds"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v1/search/fres".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v1/search/fres".format(**params) + gen_args(
