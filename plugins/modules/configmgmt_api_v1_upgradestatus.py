...
DOCUMENTATION = """
module: configmgmt_api_v1_upgradestatus
short_description: Handle resource of type configmgmt_api_v1_upgradestatus
description: Handle resource of type configmgmt_api_v1_upgradestatus
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/upgradeStatus".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/upgradeStatus".format(
        **params
