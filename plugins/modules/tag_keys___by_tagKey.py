...
DOCUMENTATION = """
module: tag_keys___by_tagKey
short_description: Handle resource of type tag_keys___by_tagKey
description: Handle resource of type tag_keys___by_tagKey
options:
  autoIndexed:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}".format(
        **params
