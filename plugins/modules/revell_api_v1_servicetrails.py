...
DOCUMENTATION = """
module: revell_api_v1_servicetrails
short_description: Handle resource of type revell_api_v1_servicetrails
description: Handle resource of type revell_api_v1_servicetrails
options:
  state:
    choices:
    - post
...
def url(params):
    return "https://{mcp_hostname}/revell/api/v1/serviceTrails/".format(**params)
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/revell/api/v1/serviceTrails/".format(
        **params
