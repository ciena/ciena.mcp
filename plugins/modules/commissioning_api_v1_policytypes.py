...
DOCUMENTATION = """
module: commissioning_api_v1_policytypes
short_description: Handle resource of type commissioning_api_v1_policytypes
description: Handle resource of type commissioning_api_v1_policytypes
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/policyTypes/".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/commissioning/api/v1/policyTypes/".format(
        **params
