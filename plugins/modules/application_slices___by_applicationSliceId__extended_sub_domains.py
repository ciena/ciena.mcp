...
DOCUMENTATION = """
module: application_slices___by_applicationSliceId__extended_sub_domains
short_description: Handle resource of type application_slices___by_applicationSliceId__extended_sub_domains
description: Handle resource of type application_slices___by_applicationSliceId__extended_sub_domains
options:
  applicationSliceId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/extended-sub-domains".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/application-slices/{applicationSliceId}/extended-sub-domains".format(
        **params
    ) + gen_args(
