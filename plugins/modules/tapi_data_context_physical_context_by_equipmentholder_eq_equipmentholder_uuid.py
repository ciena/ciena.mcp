...
DOCUMENTATION = """
module: tapi_data_context_physical_context_by_equipmentholder_eq_equipmentholder_uuid
short_description: Handle resource of type tapi_data_context_physical_context_by_equipmentholder_eq_equipmentholder_uuid
description: Handle resource of type tapi_data_context_physical_context_by_equipmentholder_eq_equipmentholder_uuid
options:
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/physical-context/equipmentholder={equipmentholder-uuid}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/physical-context/equipmentholder={equipmentholder-uuid}".format(
        **params
    ) + gen_args(
