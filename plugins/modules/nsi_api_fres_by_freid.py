...
DOCUMENTATION = """
module: nsi_api_fres_by_freid
short_description: Handle resource of type nsi_api_fres_by_freid
description: Handle resource of type nsi_api_fres_by_freid
options:
  data:
    description:
  ...
  freId:
    ...
    - Required with I(state=['delete', 'get', 'patch', 'put'])
    - Used by I(state=['delete', 'get', 'patch', 'put'])
    type: str
  include:
    description:
