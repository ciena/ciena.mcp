...
DOCUMENTATION = """
module: nsi_api_v3_physicallocations_by_physicallocationid
short_description: Handle resource of type nsi_api_v3_physicallocations_by_physicallocationid
description: Handle resource of type nsi_api_v3_physicallocations_by_physicallocationid
options:
  physicalLocationId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/physicalLocations/{physicalLocationId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/physicalLocations/{physicalLocationId}".format(
        **params
    ) + gen_args(
