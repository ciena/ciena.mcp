...
DOCUMENTATION = """
module: ifd_api_serviceintents
short_description: Handle resource of type ifd_api_serviceintents
description: Handle resource of type ifd_api_serviceintents
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/serviceIntents".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/ifd/api/serviceIntents".format(**params) + gen_args(
