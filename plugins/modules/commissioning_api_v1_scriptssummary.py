...
DOCUMENTATION = """
module: commissioning_api_v1_scriptssummary
short_description: Handle resource of type commissioning_api_v1_scriptssummary
description: Handle resource of type commissioning_api_v1_scriptssummary
options:
  projectname:
    description:
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/scriptsSummary/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/commissioning/api/v1/scriptsSummary/".format(
        **params
