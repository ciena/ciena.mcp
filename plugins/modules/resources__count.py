...
DOCUMENTATION = """
module: resources__count
short_description: Handle resource of type resources__count
description: Handle resource of type resources__count
options:
  domainId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resources/count".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resources/count".format(
        **params
