...
DOCUMENTATION = """
module: configmgmt_api_v2_customscripts
short_description: Handle resource of type configmgmt_api_v2_customscripts
description: Handle resource of type configmgmt_api_v2_customscripts
options:
  description:
    description:
  ...
  metaDataFields:
    description:
    - '(Optional) List of meta data to be included. The allowed values are: protocolType,
      typeGroup'
    - Used by I(state=['get'])
    type: str
  offset:
...
def prepare_argument_spec():
    ...
    argument_spec["scriptName"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["scriptId"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["protocolType"] = {"type": "str", "operationIds": ["get"]}
    ...
    argument_spec["description"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v2/customScripts".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v2/customScripts".format(
        **params
