...
DOCUMENTATION = """
module: nsi_api_v3_fres_by_freid_expectations_by_expectationid_realize
short_description: Handle resource of type nsi_api_v3_fres_by_freid_expectations_by_expectationid_realize
description: Handle resource of type nsi_api_v3_fres_by_freid_expectations_by_expectationid_realize
options:
  expectationId:
    description:
...
async def _post(params, session):
    accepted_fields = ["expectationId", "freId"]
    spec = {}
