...
DOCUMENTATION = """
module: tapi_data_context_physical_context_equipment
short_description: Handle resource of type tapi_data_context_physical_context_equipment
description: Handle resource of type tapi_data_context_physical_context_equipment
options:
  page[number]:
    description:
...
def url(params):
    return (
        "https://{mcp_hostname}/tapi/data/context/physical-context/equipment/".format(
            **params
        )
    )
