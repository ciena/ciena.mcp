...
DOCUMENTATION = """
module: configmgmt_api_v1_backuprestorestatus
short_description: Handle resource of type configmgmt_api_v1_backuprestorestatus
description: Handle resource of type configmgmt_api_v1_backuprestorestatus
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/backupRestoreStatus".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/backupRestoreStatus".format(
        **params
