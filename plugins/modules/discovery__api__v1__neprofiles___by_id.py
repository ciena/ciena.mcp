...
DOCUMENTATION = """
module: discovery__api__v1__neprofiles___by_id
short_description: Handle resource of type discovery__api__v1__neprofiles___by_id
description: Handle resource of type discovery__api__v1__neprofiles___by_id
options:
  data:
    description:
  ...
  id:
    description:
    - Unique identifier of the NE Connection Profile to delete
    type: str
  state:
    choices:
    - delete
...
def url(params):
    return "https://{mcp_hostname}/discovery/api/v1/neprofiles/{id}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/discovery/api/v1/neprofiles/{id}".format(
        **params
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/discovery/api/v1/neprofiles/{id}".format(**params)
