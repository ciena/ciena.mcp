...
DOCUMENTATION = """
module: commissioning_api_v1_uap_6500_4
short_description: Handle resource of type commissioning_api_v1_uap_6500_4
description: Handle resource of type commissioning_api_v1_uap_6500_4
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/uap-6500-4/".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/commissioning/api/v1/uap-6500-4/".format(
        **params
