...
DOCUMENTATION = """
module: tapi__core__context__connectivity_service
short_description: Handle resource of type tapi__core__context__connectivity_service
description: Handle resource of type tapi__core__context__connectivity_service
options:
  limit:
    description:
...
def url(params):
    return "https://{mcp_hostname}/tapi/core/context/connectivity-service/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/core/context/connectivity-service/".format(
        **params
