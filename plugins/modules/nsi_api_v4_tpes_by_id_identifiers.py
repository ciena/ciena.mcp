...
DOCUMENTATION = """
module: nsi_api_v4_tpes_by_id_identifiers
short_description: Handle resource of type nsi_api_v4_tpes_by_id_identifiers
description: Handle resource of type nsi_api_v4_tpes_by_id_identifiers
options:
  id:
    description:
    - The TPE id
