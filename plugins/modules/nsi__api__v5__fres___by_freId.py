...
DOCUMENTATION = """
module: nsi__api__v5__fres___by_freId
short_description: Handle resource of type nsi__api__v5__fres___by_freId
description: Handle resource of type nsi__api__v5__fres___by_freId
options:
  fields:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v5/fres/{freId}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v5/fres/{freId}".format(**params) + gen_args(
