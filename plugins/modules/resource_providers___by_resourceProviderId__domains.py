...
DOCUMENTATION = """
module: resource_providers___by_resourceProviderId__domains
short_description: Handle resource of type resource_providers___by_resourceProviderId__domains
description: Handle resource of type resource_providers___by_resourceProviderId__domains
options:
  limit:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resource-providers/{resourceProviderId}/domains".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resource-providers/{resourceProviderId}/domains".format(
        **params
    ) + gen_args(
