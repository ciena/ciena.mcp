...
DOCUMENTATION = """
module: configmgmt_api_v1_port_mappings_by_id
short_description: Handle resource of type configmgmt_api_v1_port_mappings_by_id
description: Handle resource of type configmgmt_api_v1_port_mappings_by_id
options:
  id:
    description:
    - Pec code mapping definition id
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/port/mappings/{id}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/port/mappings/{id}".format(
        **params
