...
DOCUMENTATION = """
module: ifd_api_v1_serviceintents_deleteintent_by_id
short_description: Handle resource of type ifd_api_v1_serviceintents_deleteintent_by_id
description: Handle resource of type ifd_api_v1_serviceintents_deleteintent_by_id
options:
  id:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["id"] = {"type": "str", "operationIds": ["delete"]}
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/v1/serviceIntents/deleteIntent/{id}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/ifd/api/v1/serviceIntents/deleteIntent/{id}".format(
        **params
