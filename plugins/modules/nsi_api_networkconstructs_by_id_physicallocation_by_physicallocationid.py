...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id_physicallocation_by_physicallocationid
short_description: Handle resource of type nsi_api_networkconstructs_by_id_physicallocation_by_physicallocationid
description: Handle resource of type nsi_api_networkconstructs_by_id_physicallocation_by_physicallocationid
options:
  body:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/physicalLocation/{physicalLocationId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/physicalLocation/{physicalLocationId}".format(
        **params
    ) + gen_args(
