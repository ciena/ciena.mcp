...
DOCUMENTATION = """
module: nsi_api_v3_networkconstructs_by_id
short_description: Handle resource of type nsi_api_v3_networkconstructs_by_id
description: Handle resource of type nsi_api_v3_networkconstructs_by_id
options:
  fields:
    description:
  ...
  include:
    ...
    - 'List of comma separated resources to be side-loaded. The allowed values are:
      expectations, physicalLocation, parentNetworkConstruct, childNetworkConstructs,
...
def prepare_argument_spec():
    ...
    argument_spec["id"] = {"type": "str", "operationIds": ["delete", "get", "patch"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/networkConstructs/{id}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/networkConstructs/{id}".format(
        **params
