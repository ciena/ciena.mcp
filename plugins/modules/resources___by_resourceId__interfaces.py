...
DOCUMENTATION = """
module: resources___by_resourceId__interfaces
short_description: Handle resource of type resources___by_resourceId__interfaces
description: Handle resource of type resources___by_resourceId__interfaces
options:
  p:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/interfaces".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/resources/{resourceId}/interfaces".format(
        **params
    ) + gen_args(
