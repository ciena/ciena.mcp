...
DOCUMENTATION = """
module: resources___by_resourceId__promote
short_description: Handle resource of type resources___by_resourceId__promote
description: Handle resource of type resources___by_resourceId__promote
options:
  autoClean:
    description:
