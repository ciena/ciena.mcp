...
DOCUMENTATION = """
module: nsi_api_equipment_by_equipmentid_userdata_by_userdatakey
short_description: Handle resource of type nsi_api_equipment_by_equipmentid_userdata_by_userdatakey
description: Handle resource of type nsi_api_equipment_by_equipmentid_userdata_by_userdatakey
options:
  equipmentId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/equipment/{equipmentId}/userData/{userDataKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/equipment/{equipmentId}/userData/{userDataKey}".format(
        **params
    ) + gen_args(
