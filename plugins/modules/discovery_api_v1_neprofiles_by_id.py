...
DOCUMENTATION = """
module: discovery_api_v1_neprofiles_by_id
short_description: Handle resource of type discovery_api_v1_neprofiles_by_id
description: Handle resource of type discovery_api_v1_neprofiles_by_id
options:
  data:
    description:
