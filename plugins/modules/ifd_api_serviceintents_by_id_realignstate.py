...
DOCUMENTATION = """
module: ifd_api_serviceintents_by_id_realignstate
short_description: Handle resource of type ifd_api_serviceintents_by_id_realignstate
description: Handle resource of type ifd_api_serviceintents_by_id_realignstate
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/ifd/api/serviceIntents/{id}/realignState".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/ifd/api/serviceIntents/{id}/realignState".format(
        **params
