...
DOCUMENTATION = """
module: mcpview_api_v1_tapi_core_context_connectivity_service
short_description: Handle resource of type mcpview_api_v1_tapi_core_context_connectivity_service
description: Handle resource of type mcpview_api_v1_tapi_core_context_connectivity_service
options:
  page[number]:
    description:
