...
DOCUMENTATION = """
module: discovery_api_v1_neprofiles
short_description: Handle resource of type discovery_api_v1_neprofiles
description: Handle resource of type discovery_api_v1_neprofiles
options:
  data:
    description:
