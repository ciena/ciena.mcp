...
DOCUMENTATION = """
module: nsi_api_v4_networkconstructs_by_id
short_description: Handle resource of type nsi_api_v4_networkconstructs_by_id
description: Handle resource of type nsi_api_v4_networkconstructs_by_id
options:
  fields:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v4/networkConstructs/{id}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v4/networkConstructs/{id}".format(
        **params
