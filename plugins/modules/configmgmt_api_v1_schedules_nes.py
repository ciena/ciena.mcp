...
DOCUMENTATION = """
module: configmgmt_api_v1_schedules_nes
short_description: Handle resource of type configmgmt_api_v1_schedules_nes
description: Handle resource of type configmgmt_api_v1_schedules_nes
options:
  operations:
    description:
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/schedules/nes".format(**params)
...
async def _patch(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/configmgmt/api/v1/schedules/nes".format(
        **params
