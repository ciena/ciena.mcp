...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id_networkconstructplanned
short_description: Handle resource of type nsi_api_networkconstructs_by_id_networkconstructplanned
description: Handle resource of type nsi_api_networkconstructs_by_id_networkconstructplanned
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/networkConstructPlanned".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/networkConstructPlanned".format(
        **params
    ) + gen_args(
