...
DOCUMENTATION = """
module: nsi__api__v4__tpes___by_id__identifiers
short_description: Handle resource of type nsi__api__v4__tpes___by_id__identifiers
description: Handle resource of type nsi__api__v4__tpes___by_id__identifiers
options:
  id:
    description:
    - The TPE id
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v4/tpes/{id}/identifiers".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v4/tpes/{id}/identifiers".format(
        **params
