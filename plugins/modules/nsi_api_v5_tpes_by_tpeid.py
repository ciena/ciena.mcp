...
DOCUMENTATION = """
module: nsi_api_v5_tpes_by_tpeid
short_description: Handle resource of type nsi_api_v5_tpes_by_tpeid
description: Handle resource of type nsi_api_v5_tpes_by_tpeid
options:
  data:
    description:
...
async def _put(params, session):
    accepted_fields = ["data", "included", "meta", "tpeId"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v5/tpes/{tpeId}".format(**params) + gen_args(
