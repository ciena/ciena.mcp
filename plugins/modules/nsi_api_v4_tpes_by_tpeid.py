...
DOCUMENTATION = """
module: nsi_api_v4_tpes_by_tpeid
short_description: Handle resource of type nsi_api_v4_tpes_by_tpeid
description: Handle resource of type nsi_api_v4_tpes_by_tpeid
options:
  data:
    description:
