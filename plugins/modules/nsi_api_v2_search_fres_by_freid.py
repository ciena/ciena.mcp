...
DOCUMENTATION = """
module: nsi_api_v2_search_fres_by_freid
short_description: Handle resource of type nsi_api_v2_search_fres_by_freid
description: Handle resource of type nsi_api_v2_search_fres_by_freid
options:
  fields:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2/search/fres/{freId}".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v2/search/fres/{freId}".format(
        **params
