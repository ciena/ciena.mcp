...
DOCUMENTATION = """
module: tag_keys___by_tagKey__tag_values___by_tagValue
short_description: Handle resource of type tag_keys___by_tagKey__tag_values___by_tagValue
description: Handle resource of type tag_keys___by_tagKey__tag_values___by_tagValue
options:
  description:
    description:
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/tag-keys/{tagKey}/tag-values/{tagValue}".format(
        **params
    )
