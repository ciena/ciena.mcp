...
DOCUMENTATION = """
module: admin_usercache
short_description: Handle resource of type admin_usercache
description: Handle resource of type admin_usercache
options:
  state:
    choices:
    - delete
...
def url(params):
    return "https://{mcp_hostname}/rbac-e/api/v1/admin/usercache".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/rbac-e/api/v1/admin/usercache".format(
        **params
