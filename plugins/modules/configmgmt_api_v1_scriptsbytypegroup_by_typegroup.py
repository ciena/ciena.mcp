...
DOCUMENTATION = """
module: configmgmt_api_v1_scriptsbytypegroup_by_typegroup
short_description: Handle resource of type configmgmt_api_v1_scriptsbytypegroup_by_typegroup
description: Handle resource of type configmgmt_api_v1_scriptsbytypegroup_by_typegroup
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/scriptsByTypeGroup/{typeGroup}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/scriptsByTypeGroup/{typeGroup}".format(
        **params
    ) + gen_args(
