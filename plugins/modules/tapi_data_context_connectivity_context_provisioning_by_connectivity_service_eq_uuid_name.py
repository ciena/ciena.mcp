...
DOCUMENTATION = """
module: tapi_data_context_connectivity_context_provisioning_by_connectivity_service_eq_uuid_name
short_description: Handle resource of type tapi_data_context_connectivity_context_provisioning_by_connectivity_service_eq_uuid_name
description: Handle resource of type tapi_data_context_connectivity_context_provisioning_by_connectivity_service_eq_uuid_name
options:
  state:
    choices:
    - post
...
def prepare_argument_spec():
    ...
    argument_spec["value-name"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["value"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["uuid"] = {"type": "str", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/connectivity-context/provisioning/connectivity-service={uuid}/name".format(
        **params
    )
