...
DOCUMENTATION = """
module: nsi__api__v2_0__fres___by_freId__bookingData___by_bookingDataKey
short_description: Handle resource of type nsi__api__v2_0__fres___by_freId__bookingData___by_bookingDataKey
description: Handle resource of type nsi__api__v2_0__fres___by_freId__bookingData___by_bookingDataKey
options:
  bookingDataKey:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v2_0/fres/{freId}/bookingData/{bookingDataKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v2_0/fres/{freId}/bookingData/{bookingDataKey}".format(
        **params
    ) + gen_args(
