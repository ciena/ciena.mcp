...
DOCUMENTATION = """
module: configmgmt_api_v1_profiles
short_description: Handle resource of type configmgmt_api_v1_profiles
description: Handle resource of type configmgmt_api_v1_profiles
options:
  imageLocation:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["storageMethod"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["state"] = {"type": "str", "choices": ["get", "post"]}
    argument_spec["protocolType"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["profileType"] = {
        "type": "str",
        "choices": ["backup_restore", "upgrade"],
        "operationIds": ["get", "post"],
    }
    argument_spec["port"] = {"type": "int", "operationIds": ["post"]}
    argument_spec["neType"] = {"type": "str", "operationIds": ["get"]}
    argument_spec["name"] = {"type": "str", "operationIds": ["post"]}
    argument_spec["ipAddress"] = {"type": "str", "operationIds": ["post"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/profiles".format(**params)
...
async def _get(params, session):
    accepted_fields = ["profileType"]
    spec = {}
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/configmgmt/api/v1/profiles".format(
        **params
