...
DOCUMENTATION = """
module: nsi__api__v6__fres___by_freId__operations___by_operation
short_description: Handle resource of type nsi__api__v6__fres___by_freId__operations___by_operation
description: Handle resource of type nsi__api__v6__fres___by_freId__operations___by_operation
options:
  freId:
    description:
    - FRE identifier
