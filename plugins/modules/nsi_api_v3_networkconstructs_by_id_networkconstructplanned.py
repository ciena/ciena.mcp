...
DOCUMENTATION = """
module: nsi_api_v3_networkconstructs_by_id_networkconstructplanned
short_description: Handle resource of type nsi_api_v3_networkconstructs_by_id_networkconstructplanned
description: Handle resource of type nsi_api_v3_networkconstructs_by_id_networkconstructplanned
options:
  id:
    description:
    - identifier of Network Construct to be retrieved
    - Required with I(state=['get', 'patch'])
    - Used by I(state=['get', 'patch'])
    type: str
  operations:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["state"] = {"type": "str", "choices": ["get", "patch"]}
    argument_spec["operations"] = {"type": "list", "operationIds": ["patch"]}
    argument_spec["id"] = {"type": "str", "operationIds": ["get", "patch"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/networkConstructs/{id}/networkConstructPlanned".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/networkConstructs/{id}/networkConstructPlanned".format(
        **params
    ) + gen_args(
