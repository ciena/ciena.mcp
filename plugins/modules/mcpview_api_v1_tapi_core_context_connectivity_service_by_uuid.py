...
DOCUMENTATION = """
module: mcpview_api_v1_tapi_core_context_connectivity_service_by_uuid
short_description: Handle resource of type mcpview_api_v1_tapi_core_context_connectivity_service_by_uuid
description: Handle resource of type mcpview_api_v1_tapi_core_context_connectivity_service_by_uuid
options:
  state:
    choices:
    - get
