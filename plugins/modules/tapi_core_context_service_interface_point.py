...
DOCUMENTATION = """
module: tapi_core_context_service_interface_point
short_description: Handle resource of type tapi_core_context_service_interface_point
description: Handle resource of type tapi_core_context_service_interface_point
options:
  limit:
    description:
