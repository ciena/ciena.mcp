...
DOCUMENTATION = """
module: nsi_api_physicallocations_by_id_userdata_by_userdatakey
short_description: Handle resource of type nsi_api_physicallocations_by_id_userdata_by_userdatakey
description: Handle resource of type nsi_api_physicallocations_by_id_userdata_by_userdatakey
options:
  body:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/physicalLocations/{id}/userData/{userDataKey}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/physicalLocations/{id}/userData/{userDataKey}".format(
        **params
    ) + gen_args(
