...
DOCUMENTATION = """
module: configmgmt_api_v1_port_pecs
short_description: Handle resource of type configmgmt_api_v1_port_pecs
description: Handle resource of type configmgmt_api_v1_port_pecs
options:
  file:
    description:
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/port/pecs".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/port/pecs".format(
        **params
