...
DOCUMENTATION = """
module: resources___by_resourceId__operations
short_description: Handle resource of type resources___by_resourceId__operations
description: Handle resource of type resources___by_resourceId__operations
options:
  description:
    description:
