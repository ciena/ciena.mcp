...
DOCUMENTATION = """
module: mcpview_api_v1_tapi_core_context_provisioning_connectivity_service
short_description: Handle resource of type mcpview_api_v1_tapi_core_context_provisioning_connectivity_service
description: Handle resource of type mcpview_api_v1_tapi_core_context_provisioning_connectivity_service
options:
  state:
    choices:
    - post
