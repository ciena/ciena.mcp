...
DOCUMENTATION = """
module: nsi__api__v3__fres___by_freId__expectations
short_description: Handle resource of type nsi__api__v3__fres___by_freId__expectations
description: Handle resource of type nsi__api__v3__fres___by_freId__expectations
options:
  data:
    description:
    - 'Validate attributes are:'
    - ' - C(attributes) (dict): '
    - ' - C(id) (str): The unique identifier of the fre expectation'
    - ' - C(relationships) (dict): '
    - ' - C(type) (str): The fre expectation type'
    type: dict
  freId:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/fres/{freId}/expectations".format(
        **params
    )
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/v3/fres/{freId}/expectations".format(
        **params
    )
