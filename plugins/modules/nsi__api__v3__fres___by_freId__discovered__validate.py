...
DOCUMENTATION = """
module: nsi__api__v3__fres___by_freId__discovered__validate
short_description: Handle resource of type nsi__api__v3__fres___by_freId__discovered__validate
description: Handle resource of type nsi__api__v3__fres___by_freId__discovered__validate
options:
  freId:
    description:
    - FRE identifier
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/fres/{freId}/discovered/validate".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/fres/{freId}/discovered/validate".format(
        **params
