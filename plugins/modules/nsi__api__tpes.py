...
DOCUMENTATION = """
module: nsi__api__tpes
short_description: Handle resource of type nsi__api__tpes
description: Handle resource of type nsi__api__tpes
options:
  concrete:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/tpes".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/tpes".format(**params) + gen_args(
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/nsi/api/tpes".format(**params)
