...
DOCUMENTATION = """
module: nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid
short_description: Handle resource of type nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid
description: Handle resource of type nsi_api_networkconstructs_by_id_expectations_by_networkconstructexpectationid
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations/{networkConstructExpectationId}".format(
        **params
    )
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/networkConstructs/{id}/expectations/{networkConstructExpectationId}".format(
        **params
    ) + gen_args(
