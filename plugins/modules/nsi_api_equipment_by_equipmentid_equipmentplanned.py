...
DOCUMENTATION = """
module: nsi_api_equipment_by_equipmentid_equipmentplanned
short_description: Handle resource of type nsi_api_equipment_by_equipmentid_equipmentplanned
description: Handle resource of type nsi_api_equipment_by_equipmentid_equipmentplanned
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/equipment/{equipmentId}/equipmentPlanned".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/equipment/{equipmentId}/equipmentPlanned".format(
        **params
    ) + gen_args(
