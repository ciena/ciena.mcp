...
DOCUMENTATION = """
module: nsi__api__v3__tpes___by_tpeId
short_description: Handle resource of type nsi__api__v3__tpes___by_tpeId
description: Handle resource of type nsi__api__v3__tpes___by_tpeId
options:
  fields:
    description:
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/v3/tpes/{tpeId}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/nsi/api/v3/tpes/{tpeId}".format(**params) + gen_args(
