...
DOCUMENTATION = """
module: admin_current_permissions
short_description: Handle resource of type admin_current_permissions
description: Handle resource of type admin_current_permissions
options:
  state:
    choices:
    - get
...
def url(params):
    return "https://{mcp_hostname}/rbac-e/api/v1/admin/current-permissions".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/rbac-e/api/v1/admin/current-permissions".format(
        **params
