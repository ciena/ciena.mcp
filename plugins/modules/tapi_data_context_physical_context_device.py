...
DOCUMENTATION = """
module: tapi_data_context_physical_context_device
short_description: Handle resource of type tapi_data_context_physical_context_device
description: Handle resource of type tapi_data_context_physical_context_device
options:
  page[number]:
    description:
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/physical-context/device/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/physical-context/device/".format(
        **params
