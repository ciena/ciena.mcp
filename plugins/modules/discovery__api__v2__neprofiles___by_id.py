...
DOCUMENTATION = """
module: discovery__api__v2__neprofiles___by_id
short_description: Handle resource of type discovery__api__v2__neprofiles___by_id
description: Handle resource of type discovery__api__v2__neprofiles___by_id
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/discovery/api/v2/neprofiles/{id}".format(**params)
...
async def _put(params, session):
    ...
    for i in accepted_fields:
        if params[i]:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/discovery/api/v2/neprofiles/{id}".format(**params)
