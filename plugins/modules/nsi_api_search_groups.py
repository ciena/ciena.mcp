...
DOCUMENTATION = """
module: nsi_api_search_groups
short_description: Handle resource of type nsi_api_search_groups
description: Handle resource of type nsi_api_search_groups
options:
  fields:
    description:
...
def prepare_argument_spec():
    ...
    argument_spec["parentGroup"] = {"type": "str", "operationIds": ["get"]}
    ...
    argument_spec["groupType"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/nsi/api/search/groups".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/nsi/api/search/groups".format(**params) + gen_args(
