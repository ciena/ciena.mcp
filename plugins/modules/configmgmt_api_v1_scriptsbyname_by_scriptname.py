...
DOCUMENTATION = """
module: configmgmt_api_v1_scriptsbyname_by_scriptname
short_description: Handle resource of type configmgmt_api_v1_scriptsbyname_by_scriptname
description: Handle resource of type configmgmt_api_v1_scriptsbyname_by_scriptname
options:
  scriptName:
    description:
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/scriptsByName/{scriptName}".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/scriptsByName/{scriptName}".format(
        **params
