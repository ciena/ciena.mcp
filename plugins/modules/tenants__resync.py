...
DOCUMENTATION = """
module: tenants__resync
short_description: Handle resource of type tenants__resync
description: Handle resource of type tenants__resync
options:
  state:
    choices:
    - post
...
def url(params):
    return "https://{mcp_hostname}/bpocore/market/api/v1/tenants/resync".format(
        **params
    )
...
async def _post(params, session):
    _url = "https://{mcp_hostname}/bpocore/market/api/v1/tenants/resync".format(
        **params
