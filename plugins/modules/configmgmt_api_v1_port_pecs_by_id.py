...
DOCUMENTATION = """
module: configmgmt_api_v1_port_pecs_by_id
short_description: Handle resource of type configmgmt_api_v1_port_pecs_by_id
description: Handle resource of type configmgmt_api_v1_port_pecs_by_id
options:
  id:
    description:
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/port/pecs/{id}".format(**params)
...
async def _delete(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/port/pecs/{id}".format(
        **params
