...
DOCUMENTATION = """
module: configmgmt_api_v1_backupimages
short_description: Handle resource of type configmgmt_api_v1_backupimages
description: Handle resource of type configmgmt_api_v1_backupimages
options:
  nename:
    description:
...
- python >= 3.6
"""
IN_QUERY_PARAMETER = ["nename", "netype"]
...
def prepare_argument_spec():
    ...
    argument_spec["nename"] = {"type": "str", "operationIds": ["get"]}
...
def url(params):
    return "https://{mcp_hostname}/configmgmt/api/v1/backupImages".format(**params)
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/configmgmt/api/v1/backupImages".format(
        **params
