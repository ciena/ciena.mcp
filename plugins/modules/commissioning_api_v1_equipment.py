...
DOCUMENTATION = """
module: commissioning_api_v1_equipment
short_description: Handle resource of type commissioning_api_v1_equipment
description: Handle resource of type commissioning_api_v1_equipment
options:
  data:
    description:
...
def url(params):
    return "https://{mcp_hostname}/commissioning/api/v1/equipment/".format(**params)
...
async def _post(params, session):
    ...
    for i in accepted_fields:
        if params[i] is not None:
            spec[i] = params[i]
    _url = "https://{mcp_hostname}/commissioning/api/v1/equipment/".format(
        **params
