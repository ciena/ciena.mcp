...
DOCUMENTATION = """
module: tapi_data_context_physical_context_equipmentholder
short_description: Handle resource of type tapi_data_context_physical_context_equipmentholder
description: Handle resource of type tapi_data_context_physical_context_equipmentholder
options:
  page[number]:
    description:
...
def url(params):
    return "https://{mcp_hostname}/tapi/data/context/physical-context/equipmentholder/".format(
        **params
    )
...
async def _get(params, session):
    _url = "https://{mcp_hostname}/tapi/data/context/physical-context/equipmentholder/".format(
        **params
    ) + gen_args(
